...
libraries/ghc-prim/dist-install/build/GHC/PrimopWrappers.hs : \
		libraries/ghc-prim/GHC/PrimopWrappers.hs-prim \
		$$(genprimopcode_INPLACE) \
		$(PRIMOPS_TXT_STAGE1) | $$(dir $$@)/.
	"$(genprimopcode_INPLACE)" $(PRIMOPS_TXT_STAGE1) $< >$@

# Required so that Haddock documents the primops.
libraries/ghc-prim_dist-install_EXTRA_HADDOCK_SRCS = libraries/ghc-prim/dist-install/build/GHC/Prim.hs

ifneq "$(BINDIST)" "YES"
$(ghc-prim-$(libraries/ghc-prim_dist-install_VERSION)_HADDOCK_FILE): \
    libraries/ghc-prim/dist-install/build/GHC/Prim.hs
libraries/ghc-prim/dist-install/doc/html/ghc-prim/ghc-prim.haddock: libraries/ghc-prim/dist-install/build/GHC/Prim.hs
endif # BINDIST

libraries/ghc-prim/dist-install/build/GHC/Prim.hs: \
			libraries/ghc-prim/GHC/Prim.hs-prim \
                        $(PRIMOPS_TXT_STAGE1) \
