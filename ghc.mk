...
libraries/ghc-prim/dist-install/build/GHC/PrimopWrappers.hs : libraries/ghc-prim/GHC/PrimopWrappers.ops $$(genprimopcode_INPLACE) $(PRIMOPS_TXT_STAGE1) | $$(dir $$@)/.
	"$(genprimopcode_INPLACE)" $(PRIMOPS_TXT_STAGE1) libraries/ghc-prim/GHC/PrimopWrappers.ops >$@

libraries/ghc-prim/dist-install/build/GHC/Prim.hs : libraries/ghc-prim/GHC/Prim.ops $$(genprimopcode_INPLACE) $(PRIMOPS_TXT_STAGE1) | $$(dir $$@)/.
	"$(genprimopcode_INPLACE)" $(PRIMOPS_TXT_STAGE1) libraries/ghc-prim/GHC/Prim.ops >$@
...
$(eval $(call sdist-ghc-file,compiler,stage2,.,GHC/Builtin/Names,ops))
$(eval $(call sdist-ghc-file,compiler,stage2,.,GHC/Builtin/PrimOps,ops))
$(eval $(call sdist-ghc-file,compiler,stage2,.,GHC/Builtin/Types/Prim,ops))
$(eval $(call sdist-ghc-file,libraries/ghc-prim,stage2,.,GHC/Prim,ops))
$(eval $(call sdist-ghc-file,libraries/ghc-prim,stage2,.,GHC/PrimopWrappers,ops))
...
# genprimopcode is needed to parse the .ops files that are in the
# ghc package.
