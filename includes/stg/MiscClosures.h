...
#if IN_STG_CODE
extern W_ stg_IND_LOCAL_tbl[];
#else
extern DLL_IMPORT_RTS const StgInfoTable *stg_IND_LOCAL_tbl[];
#endif

RTS_ENTRY(stg_IND_LOCAL0);
RTS_ENTRY(stg_IND_LOCAL1);
RTS_ENTRY(stg_IND_LOCAL2);
RTS_ENTRY(stg_IND_LOCAL3);
RTS_ENTRY(stg_IND_LOCAL4);
RTS_ENTRY(stg_IND_LOCAL5);
RTS_ENTRY(stg_IND_LOCAL6);
RTS_ENTRY(stg_IND_LOCAL7);
RTS_ENTRY(stg_IND_LOCAL8);
RTS_ENTRY(stg_IND_LOCAL9);
RTS_ENTRY(stg_IND_LOCAL10);
RTS_ENTRY(stg_IND_LOCAL11);
RTS_ENTRY(stg_IND_LOCAL12);
RTS_ENTRY(stg_IND_LOCAL13);
RTS_ENTRY(stg_IND_LOCAL14);
RTS_ENTRY(stg_IND_LOCAL15);
RTS_ENTRY(stg_IND_LOCAL16);
RTS_ENTRY(stg_IND_LOCAL17);
RTS_ENTRY(stg_IND_LOCAL18);
RTS_ENTRY(stg_IND_LOCAL19);
RTS_ENTRY(stg_IND_LOCAL20);
RTS_ENTRY(stg_IND_LOCAL21);
RTS_ENTRY(stg_IND_LOCAL22);
RTS_ENTRY(stg_IND_LOCAL23);
RTS_ENTRY(stg_IND_LOCAL24);
RTS_ENTRY(stg_IND_LOCAL25);
RTS_ENTRY(stg_IND_LOCAL26);
RTS_ENTRY(stg_IND_LOCAL27);
RTS_ENTRY(stg_IND_LOCAL28);
RTS_ENTRY(stg_IND_LOCAL29);
RTS_ENTRY(stg_IND_LOCAL30);
RTS_ENTRY(stg_IND_LOCAL31);
RTS_ENTRY(stg_IND_LOCAL32);
RTS_ENTRY(stg_IND_LOCAL33);
RTS_ENTRY(stg_IND_LOCAL34);
RTS_ENTRY(stg_IND_LOCAL35);
RTS_ENTRY(stg_IND_LOCAL36);
RTS_ENTRY(stg_IND_LOCAL37);
RTS_ENTRY(stg_IND_LOCAL38);
RTS_ENTRY(stg_IND_LOCAL39);
RTS_ENTRY(stg_IND_LOCAL40);
RTS_ENTRY(stg_IND_LOCAL41);
RTS_ENTRY(stg_IND_LOCAL42);
RTS_ENTRY(stg_IND_LOCAL43);
RTS_ENTRY(stg_IND_LOCAL44);
RTS_ENTRY(stg_IND_LOCAL45);
RTS_ENTRY(stg_IND_LOCAL46);
RTS_ENTRY(stg_IND_LOCAL47);
RTS_ENTRY(stg_IND_LOCAL48);
RTS_ENTRY(stg_IND_LOCAL49);
RTS_ENTRY(stg_IND_LOCAL50);
RTS_ENTRY(stg_IND_LOCAL51);
RTS_ENTRY(stg_IND_LOCAL52);
RTS_ENTRY(stg_IND_LOCAL53);
RTS_ENTRY(stg_IND_LOCAL54);
RTS_ENTRY(stg_IND_LOCAL55);
RTS_ENTRY(stg_IND_LOCAL56);
RTS_ENTRY(stg_IND_LOCAL57);
RTS_ENTRY(stg_IND_LOCAL58);
RTS_ENTRY(stg_IND_LOCAL59);
RTS_ENTRY(stg_IND_LOCAL60);
RTS_ENTRY(stg_IND_LOCAL61);
RTS_ENTRY(stg_IND_LOCAL62);
RTS_ENTRY(stg_IND_LOCAL63);
RTS_ENTRY(stg_IND_LOCAL64);

RTS_ENTRY(stg_IND);
RTS_ENTRY(stg_IND_direct);
RTS_ENTRY(stg_IND_noenter);
...
RTS_ENTRY(stg_STUB_BLOCKING_QUEUE);
