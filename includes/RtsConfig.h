 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * This header is included in the C stub generated by SysTools.ExtraObj.exeMain
 * to initialize the runtime system when running an executable. To minimize the
 * cost of compiling the stub we import this header directly instead of dragging
 * in all of Rts.h.
 *
 * Moreover We try very hard to keep this header and its transitive #include closure
 * small.
 *
 * Reducing this cost makes a small but measureable
