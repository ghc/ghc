 ...
 */
STATIC_INLINE StgWord traverseGetClosureData(const StgClosure *c);
STATIC_INLINE StgWord traverseGetClosureData(const StgClosure *c)
{
 ...
 * set.
 */
STATIC_INLINE void traverseSetClosureData(StgClosure *c, StgWord w);
STATIC_INLINE void traverseSetClosureData(StgClosure *c, StgWord w)
{
    ASSERT((w & 1) == 0);
 ...
 * static closures.
 */
STATIC_INLINE bool traverseIsClosureDataValid(const StgClosure *c);
STATIC_INLINE bool traverseIsClosureDataValid(const StgClosure *c)
{
