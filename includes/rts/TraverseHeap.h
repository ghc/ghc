...
typedef struct stackPos_ {
    ...
    union {
        StgWord step;
        /*< Records in which "step" of tracing the closure (e.g. which field) we
         * are. In general the meaning of this field will vary with the type of
         * the closure. traversePop and traverseGetChildren must agree on the
         * meanings of the values of this field.
         */
        ...
        /*< This mirrors StgInfoTable.layout.payload */

        StgClosure *srt;
        /*< A closure's static reference table, See init_srt_fun and
         *  init_srt_thunk. */
