...
BUILDPLATFORM_stage1 = $(BUILDPLATFORM)
BUILDPLATFORM_stage2 = $(HOSTPLATFORM)
BUILDPLATFORM_stage3 = $(TARGETPLATFORM)

HOSTPLATFORM_stage1 = $(HOSTPLATFORM)
HOSTPLATFORM_stage2 = $(TARGETPLATFORM)
HOSTPLATFORM_stage3 = $(TARGETPLATFORM)

TARGETPLATFORM_stage1 = $(TARGETPLATFORM)
TARGETPLATFORM_stage2 = $(TARGETPLATFORM)
TARGETPLATFORM_stage3 = $(TARGETPLATFORM)
...
$$(includes_stage$0_H_PLATFORM) : includes/Makefile | $$$$(dir $$$$@)/.
	...
	@echo >> $$@
	@echo "#define BuildPlatform_NAME  \"$$(BUILDPLATFORM_stage$0)\"" >> $@
	@echo "#define HostPlatform_NAME   \"$$(HOSTPLATFORM_stage$0)\"" >> $@
	@echo >> $$@
