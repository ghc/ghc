...
includes_1_H_PLATFORM = includes/dest-install/build/ghcplatform.h
...
$(foreach n,0 1 3,$(eval compiler_$n_CC_OPTS += -I$(BUILD_$n_INCLUDE_DIR)))
...
TARGETPLATFORM_0 = $(TARGETPLATFORM)
TARGETPLATFORM_1 = $(TARGETPLATFORM)
TARGETPLATFORM_2 = $(TARGETPLATFORM)
...
TargetPlatform_0_CPP = $(TargetPlatform_CPP)
TargetPlatform_1_CPP = $(TargetPlatform_CPP)
TargetPlatform_2_CPP = $(TargetPlatform_CPP)
...
$(includes_SETTINGS) : includes/ghc.mk includes/Makefile | $$(dir $$@)/.
	$(call removeFiles,$@)
...
install_includes :
	...
	$(INSTALL_HEADER) $(INSTALL_OPTS) includes/stage2/build/*.h "$(DESTDIR)$(ghcheaderdir)/" && \
