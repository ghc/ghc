...
import GHC.Driver.Types ( tyThingParent_maybe, handleFlagWarnings, getSafeMode, hsc_IC,
                  ...
                  hsc_dynLinker, hsc_interp, set_hsc_dflags, emptyModBreaks,
                  InternalUnitEnv(..), insert_hsc_unitEnv, hsc_unitDflags_maybe, hsc_unitDflags,
                  pprInternalUnitMap, emptyHomePackageTable, set_hsc_currentUnit, isAnyHomeModule,
                  hsc_allHomeUnits, hsc_memberInternalUnitEnv )
import GHC.Unit
      ...
      printForUser
        ...
        $$
          (nest 2
            ...
            $ S.toList $ hsc_allHomeUnits hsc_env
          )
  ...
  setUnitCmd' cid args = do
    ...
    case hsc_unitDflags_maybe cid hsc_env of
      Nothing -> do
        ...
        let home_units = hsc_allHomeUnits hsc_env
...
completeSwitchOptions = wrapCompleter flagWordBreakChars $ \w -> do
  hsc_env <- GHC.getSession
  return (filter (w `isPrefixOf`) (map unitIdString $ S.toList $ hsc_allHomeUnits hsc_env))
