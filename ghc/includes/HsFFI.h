/* -----------------------------------------------------------------------------
 * $Id: HsFFI.h,v 1.1 2000/04/05 15:20:41 panne Exp $
 *
 * (c) The GHC Team, 2000
 *
...
/* NOTE: This is currently not as portable as it should be. Another route
   would be including limits.h plus some #ifdef magic around the bounds of
   types without a specified size. */
#include <stdint.h>
