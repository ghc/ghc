...
$1/$2/build/%.$$($3_osuf) : $1/$4/%.hc $$$$(includes_stage$$$$5_H_CONFIG) $$$$(includes_stage$$$$5_H_PLATFORM) | $$$$(dir $$$$@)/.
...
$1/$2/build/%.$$($3_osuf) : $1/$2/build/%.hc $$$$(includes_stage$$$$5_H_CONFIG) $$$$(includes_stage$$$$5_H_PLATFORM)
	$$(call cmd,$1_$2_CC) $$($1_$2_$3_ALL_CC_OPTS) $$(addprefix -I,$$(GHC_INCLUDE_DIRS)) -x c -c $$< -o $$@ $$(if $$(findstring YES,$$($1_$2_DYNAMIC_TOO)),-dyno $$(addsuffix .$$(dyn_osuf),$$(basename $$@)))
