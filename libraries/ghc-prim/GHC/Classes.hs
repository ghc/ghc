...
x# `divInt64#` y# = ((x# `plusInt64#` bias#) `quotInt64#` y#) `minusInt64#` hard#
   where
      zero# = intToInt64# 0#
      x `andInt64#` y = word64ToInt64# (int64ToWord64# x `andWord64#` int64ToWord64# y)
      x `orInt64#` y = word64ToInt64# (int64ToWord64# x `orWord64#` int64ToWord64# y)
      notInt64# x = word64ToInt64# (notWord64# (int64ToWord64# x))
      -- See Note [divInt# implementation]
      !yn#   = intToInt64# (y# `ltInt64#` zero#)
      !c0#   = intToInt64# (x# `ltInt64#` zero#) `andInt64#` (notInt64# yn#)
      !c1#   = intToInt64# (x# `gtInt64#` zero#) `andInt64#` yn#
      !bias# = c0# `minusInt64#` c1#
      !hard# = c0# `orInt64#` c1#
...
x# `modInt64#` y# = r# `plusInt64#` k#
  where
    ...
    !c0# = intToInt64# (x# `ltInt64#` zero#) `andInt64#` (notInt64# yn#)
    !c1# = intToInt64# (x# `gtInt64#` zero#) `andInt64#` yn#
    !s#  = zero# `minusInt64#` ((c0# `orInt64#` c1#) `andInt64#` (intToInt64# (r# `neInt64#` zero#)))
    !k#  = s# `andInt64#` y#
    !r#  = x# `remInt64#` y#
...
x# `divModInt64#` y# = case (x# `plusInt64#` bias#) `quotRemInt64#` y# of
  (# q#, r# #) -> (# q# `minusInt64#` hard#, r# `plusInt64#` k# #)
  where
    zero# = intToInt64# 0#
    x `andInt64#` y = word64ToInt64# (int64ToWord64# x `andWord64#` int64ToWord64# y)
    x `orInt64#` y = word64ToInt64# (int64ToWord64# x `orWord64#` int64ToWord64# y)
    ...
    !bias# = c0# `minusInt64#` c1#
    !hard# = c0# `orInt64#` c1#
    !s#    = zero# `minusInt64#` hard#
    !k#    = (s# `andInt64#` y#) `minusInt64#` bias#
