...
-- raise exceptions in a normal way because it would create a package dependency
-- circle (base <-> bignum package). See #14664
--
-- Note that you must ensure that they are not simplified otherwise the
-- exception may not be raised:
-- 
--    case raiseDivZero of
--       _ -> print "OOPS"     -- WRONG: exception not raised
--
--    case raiseDivZero of
--       void# -> print "OOPS" -- WRONG: exception not raised
--
--    case raiseDivZero of
--       I# _ -> print "OOPS"  -- GOOD
