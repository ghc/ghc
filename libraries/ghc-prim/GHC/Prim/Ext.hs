...
-- bits of code with backend support. These aren't conventional primops because
-- the compiler doesn't care about them at all: they just are extra foreign C--
-- calls libraries can make into the RTS.
--
