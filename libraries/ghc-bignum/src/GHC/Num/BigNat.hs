...
bigNatQuotWord# a b
   | 1## <- b = a
   | 0## <- b = case divByZero of W# err -> bigNatFromWord# err
   | True =
   let
      sz = wordArraySize# a
...
bigNatRemWord# a b
   | 0## <- b       = case divByZero of W# err -> err
   | 1## <- b       = 0##
   | bigNatIsZero a = 0##
...
bigNatQuotRemWord# a b
   | 0## <- b = case divByZero of W# err -> (# bigNatZero void#, err #)
   | 1## <- b = (# a, 0## #)
   | isTrue# (bigNatSize# a ==# 1#)
...
bigNatQuotRem# a b
   | bigNatIsZero b          = case divByZero of W# err -> (# bigNatFromWord# err, bigNatZero void# #)
...
bigNatQuot a b
   | bigNatIsZero b          = case divByZero of W# err -> bigNatFromWord# err
   | bigNatIsZero a          = bigNatZero void#
   | bigNatIsOne b           = a
...
bigNatPowModWord# !_ !_ 0## = case divByZero of W# err -> err
...
bigNatPowMod !b !e !m
   ...
   | bigNatIsZero m = case divByZero of W# err -> bigNatFromWord# err
