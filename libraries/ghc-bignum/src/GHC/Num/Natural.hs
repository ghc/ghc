...
naturalFromIntThrow# i
   | isTrue# (i <# 0#) = case raiseUnderflow of W# err -> NS err
...
naturalFromInt# !i
   ...
   | True               = case raiseUnderflow of W# err -> NS err
...
naturalSubThrow (NS _) (NB _) = case raiseUnderflow of W# err -> NS err
naturalSubThrow (NB x) (NS y) = naturalFromBigNat (bigNatSubWordUnsafe# x y)
naturalSubThrow (NS x) (NS y) =
   case subWordC# x y of
      (# l,0# #) -> NS l
      (# _,_  #) -> case raiseUnderflow of W# err -> NS err
naturalSubThrow (NB x) (NB y) =
   case bigNatSub x y of
      (# () | #) -> case raiseUnderflow of W# err -> NS err
      (# | z  #) -> naturalFromBigNat z
...
naturalNegate _        = case raiseUnderflow of W# err -> NS err
...
naturalPowMod !_         !_       (NS 0##) = case raiseDivZero of W# err -> NS err
