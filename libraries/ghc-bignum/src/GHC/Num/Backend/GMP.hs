...
integer_gcde a b = case runRW# io of (# _, a #) -> a
   where
      ...
      io s =
         ...
         let !sx = absI# (extendInt32# ssx) in
         let !sy = absI# (extendInt32# ssy) in
         case mwaSetSize# mbx sx s of { s ->
         case mwaSetSize# mby sy s of { s ->
         case mwaSetSize# mbg (extendInt32# sg) s of { s ->
         ...
         (# s, (# integerFromBigNat# bg
               ,  integerFromBigNatSign# (extendInt32# ssx <# 0#) bx
               ,  integerFromBigNatSign# (extendInt32# ssy <# 0#) by #) #)
         }}}}}}}}}}}}}}}}
