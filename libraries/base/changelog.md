...
## 4.23.0.0 *TBA*
  ...
  * Provide a replacement `GHC.ByteOrder.hostByteOrder` for the
    wrongly-named `GHC.ByteOrder.targetByteOrder`, and re-export both
    `hostByteOrder` and the `ByteOrder` type from `System.Info`.
    (CLC proposal TBW)
