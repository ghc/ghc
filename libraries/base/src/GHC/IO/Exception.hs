...
module GHC.IO.Exception (
  {-# DEPRECATED "GHC.IO.Exception is deprecated and will be removed in GHC 10.02. Please ask for the inclusion of needed functionality into ghc-experimental via the GHC issue tracker." #-}
