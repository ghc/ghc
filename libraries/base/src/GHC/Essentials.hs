...
#else
-- We need to export *some* definition of JSVal and unsafeUnpackJSStringUtf8##,
-- even if the target is not JavaScript, because they are known-keys listed in
-- the known-key table. NB: The known-key table cannot CPP it out; the target
-- platform is a dynamic property
data JSVal
