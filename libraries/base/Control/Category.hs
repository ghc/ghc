...
-- arrows. Instances should satisfy the laws for @f :: cat a b@
--
-- [Right identity] @f '.' 'id' \@a  =  f@
-- [Left identity]  @'id' \@b '.' f  =  f@
-- [Associativity]  @f '.' (g '.' h)  =  (f '.' g) '.' h@
--
-- It has been polykinded since /base 4.7.0.0/
--
-- @
...
-- that work for instances of @Category@. An /isomorphism/ is an arrow
-- @f :: cat a b@ with an inverse @inv :: cat b a@
--
-- * @inv '.' f = 'id' \@a@
-- * @f '.' inv = 'id' \@b@
--
