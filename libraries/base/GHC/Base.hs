...
class Functor f where
    -- | 'fmap' is used to apply a function of type @(a -> b)@ on a value of type @f a@, where f is a functor, to produce a value of type @f b@.
    --
    -- ==== __Examples__
    --
...
class Functor f => Applicative f where
    ...
    --
    -- ==== __Examples__
    -- If used in conjunction with the Applicative instance for @'Maybe' a@,
    ...
    --
    -- >>> putStrLn "hello" *> putStrLn "World" *> getChar
    -- hello -- stdout;
    -- World -- stdout;
    -- l     -- stdin;
    -- 'l'   -- returned value. The previous results have been discarded.
    -- it :: Char
    --
    (*>) :: f a -> f b -> f b
    a1 *> a2 = (id <$ a1) <*> a2
...
-- This functions is the counterpart of 'fmap' in 'Functor' instances.
--
-- ==== __Examples__
