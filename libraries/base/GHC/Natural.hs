...
-- Note [Constant folding of @Natural@/@Integer@->@Int64@/@Word64@ conversions on 32-bit architectures]
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--
-- At present, using any of
--
...
word64ToNatural :: Word64# -> Natural
word64ToNatural w = Natural (word64ToInteger w)
{-# CONSTANT_FOLDED word64ToNatural #-}
...
#endif /* defined(MIN_VERSION_integer_gmp) */
...
-- Note [Float/Double <-> Integer/Natural conversions]
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--
-- Since @floatFromNatural@/@doubleFromNatural@ are derived from
-- @floatFromInteger@/@doubleFromInteger@ respectively, whenever a change is
-- made to the @Integer@ functions, do not forget to consider whether it should
-- be done for the functions below as well.
