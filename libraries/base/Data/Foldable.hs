...
class Foldable t where
    ...
    --
    -- >>> foldr (||) False ([False, False, True] ++ repeat False)
    -- True
    --
    -- But the following doesn't terminate:
    --
    -- >>> foldr (||) False (repeat False ++ [False, False, True])
    -- * Hangs forever *
    --
    -- ====== Laziness on the second argument
    --
    -- Applying 'foldr' to infinite structures terminates when the folding function is lazy on its second argument and only the head of the result is evaluated:
    --
