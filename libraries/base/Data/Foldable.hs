...
--
--     @
--     f :: &#x03b2; -- accumulated fold of the initial elements
--       -> &#x03b1; -- current element
--       -> &#x03b2; -- updated fold, inclusive of current element
--     @
--
...
--     @
--     f :: &#x03b1; -- current element
--       -> &#x03b2; -- accumulated fold of the remaining elements
--       -> &#x03b2; -- updated fold, inclusive of current element
--     @
--
...
--     @f@ is strict, if the Monad's bind operator is not in its right argument
--     the chain of monadic actions can short-circuit:
--
--     >>> :set -XBangPatterns
