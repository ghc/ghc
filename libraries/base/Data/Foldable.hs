...
class Foldable t where
    ...
    -- "foodcba"
    --
    -- Right-folding infinite structures then fully evaluating the result never terminates:
    --
    -- >>> foldr (+) 0 [1..]
    -- * Hangs forever *
    --
    ...
    --
    -- However evaluating the head of the result (when applicable) does terminate:
    --
    -- >>> take 5 (foldr (:) [] [1..])
    -- [1,2,3,4,5]
    foldr :: (a -> b -> b) -> b -> t a -> b
