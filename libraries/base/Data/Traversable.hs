...
-- while 'fmap' yields a list of IO actions 'traverse' constructs an IO
...
--
-- In the above we're using the __@Endo b@__ 'Monoid' and its 'Dual' to compose
-- a sequence of __@b -> b@__ accumulator updates in either left-to-right or
-- right-to-left order.
--
