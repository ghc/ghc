...
-- remains in sync with that in GHC.Tc.Deriv.Typeable to ensure that type
-- equality is correct.
...
-- This must match the computation done in GHC.Tc.Deriv.Typeable.mkTyConRepTyConRHS.
