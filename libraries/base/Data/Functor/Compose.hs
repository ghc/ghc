...
--
-- Kinds `k` and `k'` explicitly quantified since 4.15.0.0.
type    Compose :: forall k' k. (k' -> Type) -> (k -> k') -> (k -> Type)
...
--
-- @since 4.14.0.0
instance TestEquality @k' f => TestEquality @k (Compose @k @k' f g) where
