...
class Foldable t where
    ...
    -- >>> import GHC.Internal.Data.Bits (Bits, FiniteBits, xor, zeroBits)
    -- >>> import GHC.Internal.Data.Foldable (foldMap')
...
-- doesn't ignore the results see 'GHC.Internal.Data.Traversable.traverse'.
--
...
-- that doesn't ignore the results see 'GHC.Internal.Data.Traversable.for'.  This
...
-- 'GHC.Internal.Data.Traversable.mapM'.
--
...
-- doesn't ignore the results see 'GHC.Internal.Data.Traversable.forM'.
--
...
-- see 'GHC.Internal.Data.Traversable.sequenceA'.
--
...
-- results see 'GHC.Internal.Data.Traversable.sequence'.
--
...
-- example of this is 'GHC.Internal.Data.List.unfoldr' for Lists, with variants available
...
--
-- > import GHC.Internal.Data.Foldable (foldl')
-- >
-- > data PairS a b = P !a !b -- We define a strict pair datatype
-- >
