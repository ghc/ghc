...
class (Functor t, Foldable t) => Traversable t where
    ...
    -- the results see 'GHC.Internal.Data.Foldable.traverse_'.
    --
    -- ==== __Examples__
    --
    -- Basic usage:
    ...
    -- see 'GHC.Internal.Data.Foldable.sequenceA_'.
    --
    -- ==== __Examples__
    --
    -- Basic usage:
    ...
    -- a version that ignores the results see 'GHC.Internal.Data.Foldable.mapM_'.
    --
    -- ==== __Examples__
    --
    ...
    -- results see 'GHC.Internal.Data.Foldable.sequence_'.
    --
    -- ==== __Examples__
    --
    -- Basic usage:
...
-- that ignores the results see 'GHC.Internal.Data.Foldable.for_'.
for :: (Traversable t, Applicative f) => t a -> (a -> f b) -> f (t b)
{-# INLINE for #-}
for = flip traverse

-- | 'forM' is 'mapM' with its arguments flipped. For a version that
-- ignores the results see 'GHC.Internal.Data.Foldable.forM_'.
forM :: (Traversable t, Monad m) => t a -> (a -> m b) -> m (t b)
{-# INLINE forM #-}
forM = flip mapM

-- |The 'mapAccumL' function behaves like a combination of 'fmap'
-- and 'GHC.Internal.Data.Foldable.foldl'; it applies a function to each element of a structure,
...
-- and 'GHC.Internal.Data.Foldable.foldr'; it applies a function to each element of a structure,
...
-- | This function may be used as a value for `GHC.Internal.Data.Foldable.foldMap`
...
-- output structure as with e.g. 'GHC.Internal.Data.Maybe.mapMaybe'.
--
...
-- 'GHC.Internal.Control.Monad.mzero').
--
...
-- perform selective filtering as with e.g. 'GHC.Internal.Data.Maybe.catMaybes' or
-- 'GHC.Internal.Data.Either.rights':
--
...
-- > import GHC.Internal.Exts (oneShot)
-- >
...
-- unwrap __@newtype@__ terms.
--
-- The 'GHC.Internal.Exts.oneShot' function gives a hint to the compiler that aids in
...
-- on 'GHC.Internal.Data.List.zipWith', and is called 'Control.Applicative.ZipList':
--
...
--
--  * In the 'Foldable' instance, 'GHC.Internal.Data.Foldable.foldMap' should be
