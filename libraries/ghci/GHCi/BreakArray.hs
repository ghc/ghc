...
setBreakOn array inx = setIgnoreCount array inx breakOn

setBreakOff :: BreakArray -> Int -> IO Bool
setBreakOff array inx = setIgnoreCount array inx breakOff
...
setIgnoreCount :: BreakArray -> Int -> Int -> IO Bool
setIgnoreCount breakArray ind val
