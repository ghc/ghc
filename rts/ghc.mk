...
ALL_RTS_LIBS = $(foreach way,$(rts_WAYS),rts/dist/build/rts/ghc$(ProjectVersion)/$(subst dyn,,$(subst _dyn,,$(subst v,,$(way))))/libHSrts$(suffix $($(way)_libsuf)))
...
rts_$1_LIB = rts/dist/build/rts/ghc$(ProjectVersion)/$(subst dyn,,$(subst _dyn,,$(subst v,,$1)))/$$(rts_$1_LIB_FILE)
...
$$(rts_$1_LIB) : $$(rts_$1_OBJS) $(ALL_RTS_DEF_LIBS) rts/dist/libs.depend rts/dist/build/$$(LIBFFI_DLL)
	...
	rules/build-dll-win32.sh link "rts/dist/build" "rts/dist/build/rts/ghc$(ProjectVersion)/$(subst dyn,,$(subst _dyn,,$(subst v,,$1)))" "" "" "$$(rts_$1_OBJS)" "$$@" "$$(rts_dist_HC) -this-unit-id rts -shared -dynamic -dynload deploy \
...
$$(rts_$1_LIB) : $$(rts_$1_OBJS) $$(rts_$1_DTRACE_OBJS) rts/dist/libs.depend $$(rts_dist_FFI_SO)
	"$$(RM)" $$(RM_OPTS) $$@
	mkdir -p "rts/dist/build/rts/ghc$(ProjectVersion)/$(subst dyn,,$(subst _dyn,,$(subst v,,$1)))"
