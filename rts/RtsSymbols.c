...
#define RTS_X86_CPU_FEATURES2_SYMBOLS
#endif
// Alpine's and Gentoo's musl GCCs patch __builtin_cpu_init to call
// __cpu_indicator_init_local, an alias of __cpu_indicator_init. Weak
// because other musl toolchains lack the alias (and don't reference it).
#if defined(linux_HOST_OS) && !defined(__GLIBC__)
extern void __cpu_indicator_init_local(void) __attribute__((weak));
#define RTS_X86_CPU_INDICATOR_INIT_LOCAL_SYMBOLS \
      SymI_NeedsProto(__cpu_indicator_init_local)
#else
#define RTS_X86_CPU_INDICATOR_INIT_LOCAL_SYMBOLS
#endif
#define RTS_X86_CPU_MODEL_SYMBOLS \
      ...
      RTS_X86_CPU_INDICATOR_INIT_LOCAL_SYMBOLS \
