...
enum IOManagerFeatures {
     ...
     */
     ...
     /* Used internally during startup to assert that the features are
      * intentionally set. It should otherwise never be observed. */
     IOMgrNotInitialised = 1 << 31

     /* If we need more feature bits, switch to StgWord64 */
};
