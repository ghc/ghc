...
PRELUDE_CLOSURE(ghczminternal_GHCziInternalziTopHandler_runMainIOExitCode_closure);
...
#define runMainIOExitCode_closure   DLL_IMPORT_DATA_REF(ghczminternal_GHCziInternalziTopHandler_runMainIOExitCode_closure)
