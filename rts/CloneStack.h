...
extern StgClosure DLL_IMPORT_DATA_VARNAME(ghczmbase_GHCziStackziCloneStack_StackSnapshot_closure);
#define StackSnapshot_constructor_closure DLL_IMPORT_DATA_REF(ghczmbase_GHCziStackziCloneStack_StackSnapshot_closure)
