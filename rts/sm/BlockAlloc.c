...
/* Only initializes the blocks field of the first bdescr; callers are
 * responsible for calling initGroup afterwards.
 */
static bdescr *
...
finish:
    IF_DEBUG(sanity, memset(bdescr_start(bd), 0xaa, bd->blocks * BLOCK_SIZE));
