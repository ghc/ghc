                ...
                bool idle_cap[])
{
  ...
  */
  ...
  if (major_gc) {
      ...
      double scaled_factor = RtsFlags.GcFlags.returnDecayFactor > 0 ? RtsFlags.GcFlags.oldGenFactor / pow(2, (float) consec_idle_gcs / RtsFlags.GcFlags.returnDecayFactor) : 1;
