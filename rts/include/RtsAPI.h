...
__declspec(dllimport) extern StgWord ghczmbase_GHCziTopHandler_runIO_closure[];
__declspec(dllimport) extern StgWord ghczmbase_GHCziTopHandler_runNonIO_closure[];
#else
extern StgWord ghczmbase_GHCziTopHandler_runIO_closure[];
extern StgWord ghczmbase_GHCziTopHandler_runNonIO_closure[];
#endif

#define runIO_closure     ghczmbase_GHCziTopHandler_runIO_closure
#define runNonIO_closure  ghczmbase_GHCziTopHandler_runNonIO_closure
