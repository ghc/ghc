...
// isolation (e.g. by clangd) or included without Stg.h.
#ifndef RTS_EXPORT
# define RTS_EXPORT
#endif
...
extern RTS_EXPORT void hs_init     (int *argc, char **argv[]);
extern RTS_EXPORT void hs_exit     (void);
extern RTS_EXPORT void hs_exit_nowait(void);
extern RTS_EXPORT void hs_set_argv (int argc, char *argv[]);
extern RTS_EXPORT void hs_thread_done (void);
extern RTS_EXPORT void hs_restoreConsoleCP (void);

extern RTS_EXPORT void hs_perform_gc (void);
 ...
 */
extern RTS_EXPORT void hs_lock_stable_ptr_table (void);

/* A deprecated synonym. */
extern RTS_EXPORT void hs_lock_stable_tables (void);

/* Unlock the stable pointer table. */
extern RTS_EXPORT void hs_unlock_stable_ptr_table (void);

/* A deprecated synonym. */
extern RTS_EXPORT void hs_unlock_stable_tables (void);

/* Free a stable pointer assuming that the stable pointer
 * table is already locked.
 */
extern RTS_EXPORT void hs_free_stable_ptr_unsafe (HsStablePtr sp);

extern RTS_EXPORT void hs_free_stable_ptr (HsStablePtr sp);
extern RTS_EXPORT void hs_free_fun_ptr    (HsFunPtr fp);

extern RTS_EXPORT StgPtr hs_spt_lookup(StgWord64 key[2]);
extern RTS_EXPORT int hs_spt_keys(StgPtr keys[], int szKeys);
extern RTS_EXPORT int hs_spt_key_count (void);

extern RTS_EXPORT void hs_try_putmvar (int capability, HsStablePtr sp);
extern RTS_EXPORT void hs_try_putmvar_with_value (int capability, HsStablePtr sp, StgClosure *value);
