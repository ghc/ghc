...
'~' :: { Located () }
      : PREFIX_TILDE { sL1 $1 () }
      | VARSYM  {% do { unless (getVARSYM $1 == fsLit "~") $
                          addError (getLoc $1) $ text "not a tilde"
                      ; return (sL1 $1 ()) } }
...
atype :: { LHsType GhcPs }
        ...
        | PREFIX_TILDE atype             { sLL $1 $> (mkBangTy SrcLazy $2) }
        | PREFIX_BANG  atype             { sLL $1 $> (mkBangTy SrcStrict $2) }
