...
-- 'HsArrForm' and 'HsArrApp', polluting one of the core definitions.
--
...
--
-- The solution that keeps core definitions (such as HsExpr) clean and keeps
...
--      but being able to represent it brings no harm.
--
-- Observation III:
--
