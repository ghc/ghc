...
--    [t|, {, are considered "opening tokens".
--
--  * Identifiers, literals, and closing brackets ), #), ], |], },
--    are considered "closing tokens".
--
--  * Whitespace, separators, and other tokens, are considered neither opening
--    nor closing.
--
...
--
--       Preceding   | Following   | Occurrence
--      -------------+-------------+------------
--       not closing |     opening | prefix
--           closing | not opening | suffix
--           closing |     opening | tight infix
--       not closing | not opening | loose infix
--      -------------+-------------+------------
--
