...
--  ----------+----------------------+------------------
--    !  ~    |  prefix              | strictness annotation, bang/lazy pattern
...
data Token
  ...
  | ITcloseTExpQuote                    --  ||]
  | ITidEscape   FastString             --  unused, TODO (int-index): remove this (needs Haddock update)
  | ITparenEscape                       --  unused, TODO (int-index): remove this (needs Haddock update)
  | ITidTyEscape   FastString           --  unused, TODO (int-index): remove this (needs Haddock update)
  | ITparenTyEscape                     --  unused, TODO (int-index): remove this (needs Haddock update)
  | ITdollar                            --  prefix $
