...
However, note that the strictness singature for a join point can
...
will be    [A]b
meaning one absent argument, reuturns bottom.  That seems odd because
there's a \y inside.  But its's right because when consumed in a C(1)
