...
* Turning K2 into x increasse the chance of combining identical alts.
  Example      case xs of
                  (_:_) -> f xs
                  []    -> f []
  See #xxx for more examples of this kind.
...
* One alternative (perhpas a good one) would be to do OccAnal
  just before CSE.  Then perhaps we could get rid of combineIdentialALts
