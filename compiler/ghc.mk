...
$(compiler_stage1_depfile_haskell) : $(includes_stage1_H_CONFIG) $(includes_stage1_H_PLATFORM) $(COMPILER_INCLUDES_DEPS) $(PRIMOP_BITS_STAGE1)
$(compiler_stage2_depfile_haskell) : $(includes_stage2_H_CONFIG) $(includes_stage2_H_PLATFORM) $(COMPILER_INCLUDES_DEPS) $(PRIMOP_BITS_STAGE2)
$(compiler_stage3_depfile_haskell) : $(includes_stage3_H_CONFIG) $(includes_stage3_H_PLATFORM) $(COMPILER_INCLUDES_DEPS) $(PRIMOP_BITS_STAGE3)
