...
compiler/stage$1/build/GHC/Builtin/PrimOps.hs: \
		compiler/GHC/Builtin/PrimOps.hs-prim \
		compiler/stage$1/build/primops.txt \
		$$$$(genprimopcode_INPLACE) | $$$$(dir $$$$@)/.
...
compiler/stage$1/build/GHC/Builtin/Types/Prim.hs: \
		compiler/GHC/Builtin/Types/Prim.hs-prim \
		compiler/stage$1/build/primops.txt \
		$$$$(genprimopcode_INPLACE) | $$$$(dir $$$$@)/.
	$$(CP) -f compiler/GHC/Builtin/Types/Prim.hs-boot compiler/stage$1/build/GHC/Builtin/Types/Prim.hs-boot
	"$$(genprimopcode_INPLACE)" \
		compiler/stage$1/build/primops.txt \
		$$< > $$@

compiler/stage$1/build/GHC/Builtin/Names.hs: \
		compiler/GHC/Builtin/Names.hs-prim \
		compiler/stage$1/build/primops.txt \
		$$$$(genprimopcode_INPLACE) | $$$$(dir $$$$@)/.
	"$$(genprimopcode_INPLACE)" \
		compiler/stage$1/build/primops.txt \
