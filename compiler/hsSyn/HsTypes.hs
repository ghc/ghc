...
This model does not extend to visible forall. Assuming -XVisibleForall in
terms, consider:

    vfn :: forall x y -> tau(x,y)
    vfn = \a b -> ...

The user has written their own binders 'a' and 'b' to stand for 'x' and 'y',
and we definitely should not desugar this into:
