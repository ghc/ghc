...
initExternalPackageState :: Platform -> ExternalPackageState
initExternalPackageState platform
  = EPS {
      ...
      eps_rule_base        = mkRuleBase $ builtinRules platform,
      ...
      eps_stats = EpsStats { n_ifaces_in = 0, n_decls_in = 0, n_decls_out = 0
                           ...
                           , n_rules_in = length $ builtinRules platform
                           , n_rules_out = 0
                           }
    }
