  ...
  case promoted of
    IsPromoted
      -> let tys = appArgsIfaceTypes args
         ...
         in pprPromotionQuoteI IsPromoted <>
            ppr_tuple_app args' (spaceIfPromoted (pprWithCommas pprIfaceType args'))
    ...
    NotPromoted
      ...
      ->   -- drop the RuntimeRep vars.
         ...
         ppr_tuple_app args' (pprWithCommas pprIfaceType args')
  where
    ppr_tuple_app :: [IfaceType] -> SDoc -> SDoc
    ppr_tuple_app args_wo_runtime_reps ppr_args_wo_runtime_reps
        -- TODO RGS: Docs
      ...
      | otherwise
      = tupleParens sort ppr_args_wo_runtime_reps
