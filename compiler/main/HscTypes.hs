...
module HscTypes (
        ...
        -- * Interfaces
        ModIface, PartialModIface, ModIface_(..), ModIfaceExts(..),
...
mi_fix iface name = mi_fix_fn (mi_exts iface) name `orElse` defaultFixity
...
instance (NFData a, NFData (IfaceDeclExts a)) => NFData (ModIface_ a) where
