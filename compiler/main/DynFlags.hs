...
data DynFlags = DynFlags {
  ...
  maxPmCheckDeltas      :: Int,         -- ^ Soft limit on the number of models
...
dynamic_flags_deps = [
  ...
  , make_ord_flag defFlag "fmax-pmcheck-deltas"
      (intSuffix (\n d -> d { maxPmCheckDeltas = n }))
  ...
  , (Deprecated, defFlag "fmax-pmcheck-iterations"
      (intSuffixM (\_ d ->
       do { deprecate $ "use -fmax-pmcheck-deltas instead"
          ; return d })))
