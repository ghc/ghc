...
-- See Note [Updating flag description in the User's Guide]
     DynFlags {
        ...
        buildTag                = mkBuildTag (filter (/= WayThreaded) (defaultWays mySettings)),
        splitInfo               = Nothing,
...
--       " To switch back to non-threaded RTS use -non-threaded.")
...
--       " To switch back to non-threaded RTS use -non-threaded.")
  , make_ord_flag defGhcFlag "non-threaded"
