...
dffvExpr (ConApp dc cargs)    = insert (dataConWorkId dc) >> mapM_ dffvExpr cargs -- safe use of compressed args
...
cafRefsE p (ConApp _ cargs)    = any (cafRefsE p) cargs -- safe use of compressed args
