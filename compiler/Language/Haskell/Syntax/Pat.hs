...
type HsRecField    p arg = HsFieldBind (Located (FieldOcc p)) arg

-- | Haskell Record Update Field
type HsRecUpdField p     = HsFieldBind (Located (AmbiguousFieldOcc p)) (LHsExpr p)
...
hsRecFieldSel :: HsRecField p arg -> XCFieldOcc p
hsRecFieldSel = extFieldOcc . unLoc . hfbLHS
