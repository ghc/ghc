...
templateHaskellNames = [
    ...
    -- DerivStrategy
    bespokeDataConName, anyclassDataConName, newtypeDataConName,
    -- TExp
    tExpDataConName,
    -- RuleBndr
...
-- data DerivStrategy = ...
bespokeDataConName, anyclassDataConName, newtypeDataConName :: Name
bespokeDataConName  = thCon (fsLit "Bespoke")  bespokeDataConKey
...
-- data DerivStrategy = ...
bespokeDataConKey, anyclassDataConKey, newtypeDataConKey :: Unique
bespokeDataConKey  = mkPreludeDataConUnique 113
