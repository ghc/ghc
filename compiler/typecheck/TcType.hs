...
Notice that in the recursive-superclass case we including C again at
the end of the chain.  One could not-include C in this case, but
the code is more awkward and there seems not good reason to do so.
