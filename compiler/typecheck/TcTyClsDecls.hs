...
generaliseTyClDecl inferred_tc_env (L _ decl) =
  ...
  in mapAndReportM (generaliseTcTyCon swizzle_env) inferred_tcs
  where
...
generaliseTcTyCon swizzle_env tc
  ...
  = setSrcSpan (getSrcSpan tc) $
    ...
    do { let tc_name      = tyConName tc
       ...
       -- Step 2: Find the Specified and Inferred variables
       ...
       -- Step 3a: find all the Inferred variables we want to quantify over
       ...
       -- Step 3b: quantify, mainly meaning skolemise the free variables
