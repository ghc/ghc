        ...
        Specified ->
         -- Invisible and specified binder with visible kind argument
          do { traceTc "tcInferApps (vis kind app)"
             ...
             ; (subst', fun') <- extendTvSubstM subst fun ki_binder ki_arg
      ...
      (HsValArg arg : args, Just (ki_binder, inner_ki))
        ...
        | otherwise
         -> do { traceTc "tcInferApps (vis normal app)"
                ...
                ; (subst', fun') <- extendTvSubstM subst fun ki_binder arg'
...
extendTvSubstM :: TCvSubst
               -> TcType -> TyCoBinder
               -> TcType
               -> TcM (TCvSubst, TcType)
-- Precondition: for (extendTvSubstM subst fun bndr arg)
--       tcTypeKind fun  =  Pi bndr. body
--  That is, fun always has a ForAllTy or FunTy at the top
--           and 'bndr' is fun's pi-bider
extendTvSubstM subst fun (Anon {}) arg
...
extendTvSubstM subst fun (Named (Bndr tv _)) arg
