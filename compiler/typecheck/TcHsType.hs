...
-- declaration, check that the return kind is @Type@. If the declaration is a
-- @newtype@ or @newtype instance@ and the @UnliftedNewtypes@ extension is
-- enabled, this check is slightly relaxed so that a return kind of the
-- form @TYPE r@ (for some @r@) is permitted.
