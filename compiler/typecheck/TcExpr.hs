  ...
  = case tcSplitFunTy_maybe =<< checkingExpType_maybe res_ty of
      ...
      Just (arg, _) -> do { sel_name <- disambiguateSelector lbl arg
                          ; tcCheckRecSelId rn_expr (Unambiguous sel_name lbl)
                                                    res_ty }
tcCheckRecSelId _ (NewAmbiguousFieldOcc _) _ = panic "tcCheckRecSelId"
...
tcInferRecSelId (NewAmbiguousFieldOcc _) = panic "tcInferRecSelId"
...
tcRecordField _ _ (L _ (NewFieldOcc _)) _ = panic "tcRecordField"
