  ...
  = addPatSynCtxt lname $
    ...
    do { prov_dicts <- mapM zonkId prov_dicts
       ...
       ; tc_patsyn_finish lname dir is_infix lpat' prag_fn
                          ...
                          pat_ty rec_fields } }
tcInferPatSynDecl (XPatSynBind _) _ = panic "tcInferPatSynDecl"
...
tcCheckPatSynDecl (XPatSynBind _) _ _ = panic "tcCheckPatSynDecl"
...
When no pragma is provided for a pattern, the builder tends to be inlined, but
not the matcher.
 -}
