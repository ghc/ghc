...
when typechecking these HsBinds so that the user does not have to. Although
ImpredicativeTypes is somewhat fragile, this is a relatively safe use
of impredicativity, as the type variable `a` is underneath an arrow (->) type
constructor.
-}
