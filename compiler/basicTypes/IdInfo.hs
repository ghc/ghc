...
module IdInfo (
        ...
        coVarDetails, isCoVarDetails, isCoHoleDetails,
...
-- | Check if an 'IdDetails' says 'CoHoleID'.
isCoHoleDetails :: IdDetails -> Bool
isCoHoleDetails CoHoleId = True
isCoHoleDetails _        = False
