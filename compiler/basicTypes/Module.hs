...
-- | Indicates whether a module is a boot module (hs-boot file) or not.
type IsBootInterface = Bool

data ModuleNameWithIsBoot = ModuleNameWithIsBoot
  { moduleNameWithIsBoot_moduleName :: ModuleName
  , moduleNameWithIsBoot_isBoot :: IsBootInterface
  } deriving (Eq, Ord)
...
data ModuleWithIsBoot = ModuleWithIsBoot
  { moduleWithIsBoot_module :: Module
  , moduleWithIsBoot_isBoot :: IsBootInterface
  } deriving (Eq, Ord)
