...
Note [Summarising DmdType as StrictSig]
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
higher than the arity of the call demand that elicited that DmdType. This happens
for anonymous lambdas and in dmdTransform, for example.
...
-- unleashable at that arity. See Note [Summarising DmdType as StrictSig]
