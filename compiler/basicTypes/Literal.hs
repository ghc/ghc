...
wrapLitNumber dflags v@(LitNumber nt i t) = case nt of
  ...
  LitNumNatural -> v
  where
    int32  = LitNumber nt (wrapInt32 i) t
    word32 = LitNumber nt (wrapWord32 i) t
    int64  = LitNumber nt (wrapInt64 i) t
    word64 = LitNumber nt (wrapWord64 i) t
wrapLitNumber _ x = x
