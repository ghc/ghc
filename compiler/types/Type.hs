...
import {-# SOURCE #-} Coercion( mkNomReflCo, mkGReflCo, mkReflCo
                              ...
                              , decomposePiCos, coercionKind, coercionLeftKind
                              , coercionRightKind, coercionType
                              , isReflexiveCo, seqCo )
...
typeKind (CastTy _ty co)   = coercionRightKind co
...
tcTypeKind (CastTy _ty co)   = coercionRightKind co
