...
-- See Note [Free variables of types]
tyCoVarsOfCo co = closeOverKinds (shallowTyCoVarsOfCo co)

tyCoVarsOfCos :: [Coercion] -> TyCoVarSet
tyCoVarsOfCos cos = closeOverKinds (shallowTyCoVarsOfCos cos)
...
ty_co_vars_of_co (ForAllCo tv kco co) is acc = ty_co_vars_of_co kco is $
...
ty_co_vars_of_co (HoleCo {})          _  acc = acc
