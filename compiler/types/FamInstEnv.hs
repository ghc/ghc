...
normalise_args fun_ki roles args
  = do { (xis, cos, res_co) <- simplifyArgsWorker normalise_nominal
                                                  normalise_representational
                                                  normalise_phantom
                                                  ki_binders inner_ki fvs roles args
  ...
  where
    ...
    normalise_nominal _binder ty
      = impedance_match $ withRole Nominal $ normalise_type ty
    normalise_representational _binder ty
      = impedance_match $ withRole Representational $ normalise_type ty
    normalise_phantom _binder ty
      = impedance_match $ withRole Phantom $ normalise_type ty
