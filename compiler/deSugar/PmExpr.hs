...
eqPmAltCon :: PmAltCon -> PmAltCon -> Maybe Bool
eqPmAltCon (PmAltConLike cl1) (PmAltConLike cl2) = decEqConLike cl1 cl2
eqPmAltCon (PmAltLit     l1)  (PmAltLit     l2)  = decEqPmLit l1 l2
eqPmAltCon _                  _                  = Nothing

-- | Syntactic equality.
instance Eq PmAltCon where
  a == b = eqPmAltCon a b == Just True
