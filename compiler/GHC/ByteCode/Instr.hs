...
data BCInstr
   ...
   -- jump to the given label if the thread should stop, and fall through
   -- otherwise. See Note [Join points as loops] in GHC.StgToByteCode.
   | YIELD_CHECK      LocalLabel
...
instance Outputable BCInstr where
   ...
   ppr (YIELD_CHECK lab)     = text "YIELD_CHECK" <+> ppr lab
