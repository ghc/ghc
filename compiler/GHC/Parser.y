...
export  :: { LIE GhcPs }
        ...
        | maybe_warning_pragma 'pattern' qcon            {% do { addPsMessage (getLoc $2) PsWarnPatternNamespaceSpecifier
...
import  :: { OrdList (LIE GhcPs) }
        ...
        | 'pattern' qcon            {% do { addPsMessage (getLoc $1) PsWarnPatternNamespaceSpecifier
