...
atype :: { LHsType GhcPs }
        ...
        | '(' ')'                        {% acsA (\cs -> sLL $1 $> $ HsTupleTy (ApiAnn (glR $1) [mop $1,mcp $2] cs)
        ...
        | infixexp qop exp10p    -- See Note [Pragmas and operator fixity]
                               { ECP $
                                 ...
                                 ammsA (mkHsOpAppPV (noAnnSrcSpan $ comb2A (reLoc $1) $>) $1 $2 $3
                                       (ApiAnn (glAR $1) [mjA AnnVal $2] noCom))
                                     [mjA AnnVal $2] }
...
fexp    :: { ECP }
        ...
        | fexp PREFIX_AT atype       {% runECP_P $1 >>= \ $1 ->
                                        ...
                                        fmap ecpFromExp $
                                        fmap reLocA $ ams (\cs -> sLL (reLoc $1) (reLoc $>) $ HsAppType (comment (glAR $1) cs) $1 (mkHsWildCardBndrs $3))
                                            [mj AnnAt $2] }
...
addAnnotationS :: MonadP m => SrcSpan -- SrcSpan of enclosing AST construct
               ...
               -> m ()
addAnnotationS (RealSrcSpan l _) kw (RealSrcSpan v _) = addAnnotation l kw v
...
addAnnotationA (L la a) kw span = do
  ...
  let anns' = addAnns (ann la) [AddApiAnn kw (rs span)] cs
