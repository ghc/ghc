...
atype :: { LHsType GhcPs }
        ...
        | SIMPLEQUOTE '(' ')'         {% do { requireLTPuns PEP_QuoteDisambiguation $1 $>
                                            ; amsA' (sLL $1 $> $ HsExplicitTupleTy (epTok $1,AnnParens (epTok $2) (epTok $3)) IsPromoted [] Boxed) }}
...
list :: { forall b. DisambECP b => SrcSpan -> (EpaLocation, EpaLocation) -> PV (LocatedA b) }
        : texp    { \loc (ao,ac) -> unECP $1 >>= \ $1 ->
                            mkHsExplicitListPV loc [$1] (NoEpTok, EpTok ao, EpTok ac) }
        | lexps   { \loc (ao,ac) -> $1 >>= \ $1 ->
                            mkHsExplicitListPV loc (reverse $1) (NoEpTok, EpTok ao, EpTok ac) }
        | texp '..'  { \loc (ao,ac) -> unECP $1 >>= \ $1 ->
