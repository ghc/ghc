        ...
        | aexp1 TIGHT_INFIX_PROJ field
            {% runPV (unECP $1) >>= \ $1 ->
               fmap ecpFromExp $ acsa (\cs ->
                 let fl = sLL $2 $> (DotFieldOcc ((EpAnn (glR $2) (AnnFieldLabel (Just $ glAA $2)) emptyComments)) (unLoc $3)) in
...
projection
        ...
        : projection TIGHT_INFIX_PROJ field
                             {% acs (\cs -> sLL $1 $> ((sLL $2 $> $ DotFieldOcc (EpAnn (glR $1) (AnnFieldLabel (Just $ glAA $2)) cs) (unLoc $3)) : unLoc $1)) }
        | PREFIX_PROJ field  {% acs (\cs -> sLL $1 $>  [sLL $1 $> $ DotFieldOcc (EpAnn (glR $1) (AnnFieldLabel (Just $ glAA $1)) cs) (unLoc $2)]) }
...
fbind   :: { forall b. DisambECP b => PV (Fbind b) }
        ...
        | field TIGHT_INFIX_PROJ fieldToUpdate '=' texp
                        { do
                            let top = sL1 $1 $ DotFieldOcc noAnn (unLoc $1)
        ...
        | field TIGHT_INFIX_PROJ fieldToUpdate
                        { do
                            let top =  sL1 $1 $ DotFieldOcc noAnn (unLoc $1)
                                ...
                                l = comb2 $1 $3
                                isPun = True
                            var <- mkHsVarPV (L (noAnnSrcSpan $ getLoc final) (mkRdrUnqual . mkVarOcc . unpackFS . dfoLabel . unLoc $ final))
...
fieldToUpdate
        ...
        : fieldToUpdate TIGHT_INFIX_PROJ field   {% getCommentsFor (getLoc $3) >>= \cs ->
                                                     return (sLL $1 $> ((sLL $2 $> (DotFieldOcc (EpAnn (glR $2) (AnnFieldLabel $ Just $ glAA $2) cs) (unLoc $3))) : unLoc $1)) }
        | field       {% getCommentsFor (getLoc $1) >>= \cs ->
                        return (sL1 $1 [sL1 $1 (DotFieldOcc (EpAnn (glR $1) (AnnFieldLabel Nothing) cs) (unLoc $1))]) }
