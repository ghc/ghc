...
import GHC.Core.TyCoFVs ( tyCoVarsOfCoList, tyCoFVsOfTypes )
import GHC.Core.TyCoSubst ( mkTvSubst )
...
see Note [Non-trivial definitional equality] in GHC.Core.TyCoRep
