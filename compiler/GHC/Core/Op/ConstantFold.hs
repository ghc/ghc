...
instance Monad RuleM where
  RuleM f >>= g
    = RuleM $ \platform iu fn args ->
              case f platform iu fn args of
                Nothing -> Nothing
                Just r  -> runRuleM (g r) platform iu fn args
...
instance Alternative RuleM where
  ...
  RuleM f1 <|> RuleM f2 = RuleM $ \platform iu fn args ->
    f1 platform iu fn args <|> f2 platform iu fn args
