...
************************************************************************
*                                                                      *
\subsection{Basic Core construction}
*                                                                      *
************************************************************************
-}
...
-- appropriate (see Note [Core let/app invariant])
...
--   See GHC.Core Note [Core let/app invariant]
...
-- Respects the let/app invariant by building a case expression where necessary
--   See Note [GHC.Core let/app invariant] in GHC.Core
...
their counterparts in GHC.Core, but they are here for consistency
-}
...
aBSENT_ERROR_ID
 ...
 where
   ...
   -- lifted-type things; see Note [Absent errors] in WorkWrapLib
