...
-- boot libraries used by `base` (see #17791).
--
-- Now we use `ghc-prim:GHC.Prim.Panic.absentSumFieldError` as a wired-in
-- closure. It directly calls into the RTS to panic.
--
