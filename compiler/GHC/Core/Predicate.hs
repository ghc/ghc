...
module GHC.Core.Predicate (
  ...
  -- Equality predicates
  EqRel(..), eqRelRole,
  isEqPredTy, isReprEqPred, isEqClassPred, isCoVarType,
  ...
  -- Implicit parameters
  isIPLikePred, mentionsIP, isIPTyCon, isIPClass, decomposeIPPred,
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
A "predicate" or "predicate type", type synonym `PredType`, is any type of
kind (CONSTRAINT r) for some `r`.
