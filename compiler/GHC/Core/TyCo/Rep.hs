...
instance Ord TyLit where
   ...
   compare (CharTyLit x) (CharTyLit x) = compare x y
   compare (CharTyLit _) (StrTyLit _)   = LT
   compare (StrTyLit _) (CharTyLit _)   = GT
   compare (CharTyLit _) (NumTyLit _)   = LT
   compare (NumTyLit _) (CharTyLit _)   = GT
