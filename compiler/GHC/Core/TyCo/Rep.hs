...
-- thing but in the *local* context.  See 'GHC.Tc.Env' for how to retrieve
...
* How do we prevent a MkT having an illegal constraint like
  Eq a?  We check for this at use-sites; see GHC.Tc.Type.tcTyVar,
...
see Note [Required quantifiers in the type of a term] in GHC.Tc.Expr.
-}
...
constraint from floating] in GHC.Tc.Simplify, item (4):
