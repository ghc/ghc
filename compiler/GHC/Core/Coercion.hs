...
import GHC.Core.TyCoPpr
import GHC.Core.TyCoSubst
import GHC.Core.TyCoTidy
...
%*                                                                      *
     ...
     -- See [Coercion axioms applied to coercions] in GHC.Core.TyCoRep
...
[Respecting definitional equality] in GHC.Core.TyCoRep.
...
-- of Coercion and the Note [Refl invariant] in GHC.Core.TyCoRep.
...
See Note [Unused coercion variable in ForAllTy] in GHC.Core.TyCoRep for the motivation for
