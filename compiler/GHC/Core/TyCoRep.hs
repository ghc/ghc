...
import {-# SOURCE #-} GHC.Core.Type( coreView )
import {-# SOURCE #-} GHC.Core.TyCoPpr ( pprType, pprCo, pprTyLit )
...
this invariant, as done in GHC.Core.Type.mkAppTy. In the example above, trying to
