...
import GHC.Core.Utils   ( exprType, eqExpr, mkTick, mkTicks,
                          ...
                          isJoinBind )
import GHC.Core.Pretty  ( pprRules )
import GHC.Core.Type    as Type ( Type, Kind, substTy, mkTCvSubst )
...
-- It's here rather than in GHC.Core.Pretty because it calls tidyRules
...
but that isn't quite right:
     ...
     - The rules in GHC.Core.ConstantFold.builtinRules should be active even
