...
callSiteInline logger dflags in_scope !case_depth id
  ...
  = case idUnfolding id of
      ...
      -- be a loop breaker  (maybe the knot is not yet untied)
        CoreUnfolding { uf_tmpl = unf_template
          ...
          | active_unfolding -> tryUnfolding logger dflags in_scope case_depth id
                                    lone_variable arg_infos cont_info unf_template
...
tryUnfolding :: Logger -> DynFlags -> InScopeSet -> Int -> Id
             -> Bool -> [ArgSummary] -> CallCtxt
             -> CoreExpr -> Bool -> Bool -> UnfoldingGuidance
             -> Maybe CoreExpr
tryUnfolding logger dflags in_scope !case_depth id lone_variable
