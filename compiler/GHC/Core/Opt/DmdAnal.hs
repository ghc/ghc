...
-- CoreExpr data constructor, taking care of 'Chgd' business:

nullaryCase :: DmdType -> CoreExpr -> SPair DmdType (Chgd CoreExpr)
nullaryCase ty e = S2 ty (Clean e)

unaryCase :: DmdType -> CoreExpr -> (a -> CoreExpr) -> Chgd a -> SPair DmdType (Chgd CoreExpr)
unaryCase ty e wrap !a = S2 ty (setWhenClean e $ wrap <$> a)

binaryCase :: DmdType -> CoreExpr -> (a -> b -> CoreExpr) -> Chgd a -> Chgd b -> SPair DmdType (Chgd CoreExpr)
