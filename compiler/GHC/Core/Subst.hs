...
--
-- 1. Note [The substitution invariant] in GHC.Core.TyCoSubst
--
-- 2. Note [Substitutions apply only once] in GHC.Core.TyCoSubst
data Subst
...
For TyVars, see Note [Extending the TCvSubst] in GHC.Core.TyCoSubst.
...
-- See Note [Substitutions apply only once] in GHC.Core.TyCoSubst
--
