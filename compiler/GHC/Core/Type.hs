...
interfaces.  Notably this plays a role in tcTySigs in GHC.Tc.Binds.
...
1. Template Haskell Type reification (see, for instance, GHC.Tc.Splice.reify_tc_app)
...
specified arguments (e.g., TH reification in GHC.Tc.Splice), and sometimes the
