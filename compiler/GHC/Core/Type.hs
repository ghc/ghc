...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
As noted in Note [Forall coercions] in GHC.Core.TyCoRep, a ForAllCo is a bit redundant.
...
-- See Note [Respecting definitional equality] in GHC.Core.TyCoRep
...
-- you want. The CastTy data constructor (in GHC.Core.TyCoRep) has the
...
-- See also Note [Non-trivial definitional equality] in GHC.Core.TyCoRep.
...
Most pretty-printing is either in GHC.Core.TyCoRep or IfaceType.
