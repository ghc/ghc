...
* GHC.Tc.Utils.TcType.tcEqType implements typechecker equality (see
  Note [Typechecker equality] in GHC.Tc.Utils.TcType), which treats
  Constraint and Type as distinct. This is used during type inference.
  See #11715 for issues that arise from this.
