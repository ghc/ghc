...
module GHC.Core.OptCoercion ( optCoercion, checkAxInstCo ) where
...
import GHC.Core.Type   hiding( substTyVarBndr, substTy )
...
That last fact is due to Note [Non-trivial definitional equality] in GHC.Core.TyCoRep,
...
etaTyConAppCo_maybe tc co
  ...
  , tc1 == tc2
  , isInjectiveTyCon tc r  -- See Note [NthCo and newtypes] in GHC.Core.TyCoRep
  , let n = length tys1
