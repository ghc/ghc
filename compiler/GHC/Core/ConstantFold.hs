...
import TysWiredIn
import TysPrim
import GHC.Core.TyCon   ( tyConDataCons_maybe, isAlgTyCon, isEnumerationTyCon
                        , isNewTyCon, unwrapNewTyCon_maybe, tyConDataCons
                        , tyConFamilySize )
import DataCon     ( dataConTagZ, dataConTyCon, dataConWorkId )
import GHC.Core.Utils   ( cheapEqExpr, cheapEqExpr', exprIsHNF, exprType, stripTicksTop, stripTicksTopT, mkTicks )
...
* An application like (dataToTag# (Just x)) is optimised by
  dataToTagRule in GHC.Core.ConstantFold.

* A case expression like
     case (dataToTag# e) of <alts>
  gets transformed t
     case e of <transformed alts>
  by GHC.Core.ConstantFold.caseRules; see Note [caseRules for dataToTag]
...
- GHC.Core.ConstantFold.seqRule: eliminate (seq# <whnf> s)
