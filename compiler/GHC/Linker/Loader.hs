...
modifyMbLS_ dl f = modifyMVar_ (dl_mpls dl) f
...
dynLinkObjs :: HscEnv -> LoaderState -> [Linkable]
            -> IO (LoaderState, SuccessFlag)
...
dynLoadObjs :: HscEnv -> LoaderState -> [FilePath]
            -> IO LoaderState
...
dynLinkBCOs :: HscEnv -> LoaderState -> [Linkable]
            -> IO LoaderState
