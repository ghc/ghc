...
cvtHsDo :: HsPsStmtContext -> [TH.Stmt] -> CvtM (HsExpr GhcPs)
cvtHsDo do_or_lc stmts
  ...
  where
    bad_last stmt = vcat [ text "Illegal last statement of" <+> pprAStmtContext (PsStmt do_or_lc :: HsStmtContext GhcPs) <> colon
