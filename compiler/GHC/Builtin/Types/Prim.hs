...
All of them have kind (CONSTRAINT r) for some RuntimeRep r.

          Lifted?  Hetero?  Role      Built in         Defining module
           L/U                        TyCon
---------------------------------------------------------------------------------
~#          U      hetero   nominal   eqPrimTyCon      GHC.Prim
~~          L      hetero   nominal   heqTyCon         GHC.Types
~           L      homo     nominal   eqTyCon          GHC.Types
:~:         L      homo     nominal   (not built-in)   Data.Type.Equality
:~~:        L      hetero   nominal   (not built-in)   Data.Type.Equality

~R#         U      hetero   repr      eqReprPrimTy     GHC.Prim
Coercible   L      homo     repr      coercibleTyCon   GHC.Types
Coercion    L      homo     repr      (not built-in)   Data.Type.Coercion
~P#         U      hetero   phantom   eqPhantPrimTyCon GHC.Prim
