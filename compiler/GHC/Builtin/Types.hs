...
-- define here.
--
-- Because of their infinite nature, this list excludes tuples, unboxed tuples,
-- unboxed sums, Any, and implicit parameter TyCons
-- (see Note [Built-in syntax and the OrigNameCache] in GHC.Types.Name.Cache).
--
