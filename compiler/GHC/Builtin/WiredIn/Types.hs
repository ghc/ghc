...
--   must be wired into the compiler nonetheless.  C.f module "GHC.Builtin.WiredIn.Prim"
module GHC.Builtin.WiredIn.Types (
        -- * Helper functions defined here
        mkWiredInTyConName, -- This is used in GHC.Builtin.WiredIn.TypeLits to define the
...
-- Note [TYPE and CONSTRAINT] in GHC.Builtin.WiredIn.Prim, and
