...
--   It is then consumed by the utility program genprimopcode, which parses
--   .hs-prim files (which are Haskell files containing markers) to produce
--   final Haskell files. It is used by:
--
