...
things,
  ...
  b) The known infinite families of names are specially serialised by
     ...
     Note [How tuples work] in GHC.Builtin.WiredIn.Types.
...
wired in ones are defined in GHC.Builtin.WiredIn.Types etc.
...
-- See Note [Wiring in RuntimeRep] in GHC.Builtin.WiredIn.Types
