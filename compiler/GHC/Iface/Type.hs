...
with the SDoc option sdocPrintUsualSynonyms.
-}
...
pprTyTcApp ctxt_prec tc tys =
    sdocOption sdocPrintExplicitKinds $ \print_kinds ->
    sdocOption sdocPrintUsualSynonyms $ \print_usual_synonyms ->
    getPprDebug $ \debug ->
    pprTyTcApp' ctxt_prec tc tys (PrintExplicitKinds print_kinds)
                print_usual_synonyms debug

pprTyTcApp' :: PprPrec -> IfaceTyCon -> IfaceAppArgs
            -> PrintExplicitKinds -> Bool -> Bool -> SDoc
pprTyTcApp' ctxt_prec tc tys printExplicitKinds printUsualSynonyms debug
  ...
  , printUsualSynonyms  -- See Note [Printing usual synonyms]
