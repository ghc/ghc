...
set_mi_stub_objs val iface = clear_mi_hi_bytes $  iface { mi_stub_objs_ = val }
...
pattern ModIface ::
  ...
  IfaceBackendExts phase -> ExtensibleFields -> Fingerprint -> IfaceBinHandle phase -> [ByteString] ->
  ModIface_ phase
pattern ModIface
  { mi_module
  , mi_sig_of
