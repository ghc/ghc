...
data ModSummary
   = ModSummary {
        ...
        ms_srcimps      :: [Located ModuleName], -- FIXME: source imports are never from an external package, why do we allow PkgQual?
          -- ^ Source imports of the module
        ms_textual_imps :: [(ImportStage, PkgQual, Located ModuleName)],
...
ms_imps :: ModSummary -> [(ImportStage, PkgQual, Located ModuleName)]
ms_imps ms = ms_textual_imps ms ++ ms_plugin_imps ms

-- | Plugin imports
ms_plugin_imps :: ModSummary -> [(ImportStage, PkgQual, Located ModuleName)]
ms_plugin_imps ms = map ((SpliceStage, NoPkgQual,) . noLoc) (pluginModNames (ms_hspp_opts ms))
...
home_imps :: [(ImportStage, PkgQual, Located ModuleName)] -> [(ImportStage, PkgQual, Located ModuleName)]
...
ms_home_imps :: ModSummary -> ([(ImportStage, PkgQual, Located ModuleName)])
