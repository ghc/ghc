...
findHomeModuleAmongDeps
  ...
  -> ModuleName
  -> IO FindResult
findHomeModuleAmongDeps fc ue home_module_name_providers_map mb_home_unit scope mod_name =
...
findExposedPackageModule fc fopts units scope mod_name mb_pkg =
  findLookupResult fc fopts
    $ case lookupModuleWithSuggestions units scope mod_name mb_pkg of
