...
data Warning
     ...
     -- | Warn when tabulations are found. This warning will be raised upon the
     -- first occurrence of a tab in a file and it will store the number of other
     -- occurrences in the constructor's argument.
   = WarnTab !Word

   | WarnTransitionalLayout !TransLayoutReason
   ...
   | WarnOperatorWhitespaceExtConflict !OperatorWhitespaceSymbol
   | WarnOperatorWhitespace !FastString !OperatorWhitespaceOccurrence
