...
pprError :: Error -> ErrDoc
pprError err =
  errDoc [ vcat (pp_err_desc (errDesc err) : map pp_hint (errHints err)) ] [] []

pp_err_desc :: ErrorDesc -> MsgDoc
pp_err_desc = \case
   ErrParseRaw e
      -> e
   ...
   ErrUnsupportedExtension ext
       -> text "Unsupported extension: " <> text ext
