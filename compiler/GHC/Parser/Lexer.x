...
skip_one_varid_text :: (HText -> Token) -> Action p
...
skip_one_varid_src_text :: (SourceText -> HText -> Token) -> Action p
...
withLexedDocType :: (AlexInput -> ((HsDocStringDecorator -> HsDocString GhcPs) -> (HdkComment, Token)) -> Bool -> P p (PsLocated Token))
                 -> P p (PsLocated Token)
...
tok_qstrings :: Action p -> Action p
