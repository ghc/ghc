...
mkMultTy :: IsUnicodeSyntax -> LHsType GhcPs -> [AddAnn] ->  (HsArrow GhcPs, [AddAnn])
mkMultTy u (L _ (HsTyLit _ (HsNumTy _ 1))) _ = (HsLinearArrow u,    [])
mkMultTy u t anns                            = (HsExplicitMult u t, anns)
