...
reportHdkWarning (HdkWarnInvalidComment (L l _)) =
  addWarning Opt_WarnInvalidHaddock $ mkParserWarn (mkSrcSpanPs l) WarnHaddockInvalidPos
reportHdkWarning (HdkWarnExtraComment (L l _)) =
  addWarning Opt_WarnInvalidHaddock $ mkParserWarn l WarnHaddockIgnoreMulti
