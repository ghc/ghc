...
cgOpApp (StgPrimOp primop) args res_ty = do
    ...
    cmmPrimOpApp dflags primop cmm_args res_ty
...
cmmPrimOpApp :: DynFlags -> PrimOp -> [CmmExpr] -> Type -> FCode ReturnKind
cmmPrimOpApp dflags primop cmm_args res_ty =
...
genericIntMul2Op [res_c, res_h, res_l] both_args@[arg_x, arg_y]
 = do dflags <- getDynFlags
      ...
      _ <- withSequel (AssignTo [p, res_l] False) $
             cmmPrimOpApp dflags WordMul2Op both_args undefined
