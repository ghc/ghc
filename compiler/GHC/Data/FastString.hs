...
--          or with bytes comparison (`bytesCompareFS`).
...
-- | Compare FastString by their bytes.
--
-- A bit cheaper than `lexicalCompareFS` but not lexical (cf #18562)
bytesCompareFS :: FastString -> FastString -> Ordering
bytesCompareFS fs1 fs2 = compare (fs_sbs fs1) (fs_sbs fs2)
