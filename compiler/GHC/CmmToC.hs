...
staticLitsToWords platform = go . foldMap decomposeMultiWord
  where
    ...
    decomposeMultiWord (CmmFloat n W64)
      ...
      = [doubleToWord64 platform n]
    decomposeMultiWord (CmmFloat n W32)
      = [floatToWord32 platform n]
...
floatToWord32 :: Platform -> Rational -> CmmLit
floatToWord32 platform r
  = runST $ do
...
doubleToWord64 :: Platform -> Rational -> CmmLit
doubleToWord64 platform r
  = runST $ do
