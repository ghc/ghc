...
findUserDataReader :: forall a . (HasCallStack, Typeable a) => Proxy a -> BinHandle -> BinaryReader a
...
findUserDataWriter :: forall a . (HasCallStack, Typeable a) => Proxy a -> BinHandle -> BinaryWriter a
