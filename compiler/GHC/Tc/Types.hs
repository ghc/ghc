...
--        in GHC.Iface.{Make,Recomp}, and tcLookupGlobal in GHC.Tc.Env
--
...
-- See 'GHC.Tc.Env' for how to retrieve a 'TyThing' given a 'Name'.
data TcTyThing
...
data PromotionErr
  ...
  | PatSynPE         -- Pattern synonyms
                     -- See Note [Don't promote pattern synonyms] in GHC.Tc.Env
