...
module GHC.Tc.Types(
        ...
        Env(..),
        TcGblEnv(..), TcLclEnv(..), tcl_in_gen_code, tcl_deriving, tclSetProvenance,
        CodeProvenance(..),
...
tcl_in_gen_code tcl = tcl_provenance tcl == RebindableSyntaxCP

tcl_deriving :: TcLclEnv -> Bool
tcl_deriving tcl = tcl_provenance tcl == DerivingCP
