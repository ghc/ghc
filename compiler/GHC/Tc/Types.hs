...
-- | This data type indicates possible types of generated code.
data CodeProvenance
  = OtherCP -- ^ User source, Template Haskell, plugin, etc.
...
inRebindableSyntax _ = False

inDeriving :: TcLclEnv -> Bool
inDeriving (TcLclEnv { tcl_provenance = DerivingCP }) = True
inDeriving _ = False
