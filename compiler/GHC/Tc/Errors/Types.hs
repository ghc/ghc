...
data TcRnMessage where
  ...
  {-| TcRnDodgyImports is a warning (controlled with -Wdodgy-imports) that occurs when
      ...
      abstractly, i.e. 'T'. It's also emitted when an 'import' statement hides an entity
  ...
  {-| TcRnDodgyExports is a warning (controlled by -Wdodgy-exports) that occurs when a datatype
      ...
      type/data family. Also emitted when a module is re-exported, but that module exports nothing.
