...
instance Diagnostic TcRnMessage where
  ...
  diagnosticRelatedLocations = \case
    ...
    TcRnWithHsDocContext _ msg'
      -> diagnosticRelatedLocations msg'
    -- For these "duplicate" diagnostics the primary span is the last occurrence;
    ...
    -- whoever adds it to consider whether it has related locations; see
    -- Note [Choosing the primary and related spans] in GHC.Types.Error for how
    -- to choose them. Keep this list in alphabetical order.
    TcRnAbstractClosedTyFamDecl{} -> []
    TcRnAmbiguousFieldInUpdate{} -> []
    TcRnAmbiguousName{} -> []
    TcRnAmbiguousRecordUpdate{} -> []
