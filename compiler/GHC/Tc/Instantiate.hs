...
import {-# SOURCE #-}   GHC.Tc.Expr( tcPolyExpr, tcSyntaxOp )
import {-# SOURCE #-}   GHC.Tc.Unify( unifyType, unifyKind )
...
-- using tcSplitNestedSigmaTys in GHC.Tc.Utils.Type, which is a pure alternative that
...
-- newOverloadedLit in GHC.Tc.Unify
...
newClsInst overlap_mode dfun_name tvs theta clas tys
  = do { (subst, tvs') <- freshenTyVarBndrs tvs
       ...
       ; let tys' = substTys subst tys
             ...
             --     an InstInfo, and in GHC.Tc.Monad.Env.pprInstInfoDetails it's
