...
zonkExpr (HsVar (Unbound her) (L l occ))
  = do (her', occ') <- zonk_her her occ
       return (HsVar (Unbound her') (L l occ'))
zonkExpr (HsHole her (L l occ))
  = do (her', occ') <- zonk_her her occ
       return (HsHole her' (L l occ'))
...
zonk_her :: HoleExprRef -> Id -> ZonkTcM (HoleExprRef, Id)
zonk_her (HER ref) id
