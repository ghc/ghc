...
import {-# SOURCE #-} GHC.Tc.Hole.FitTypes ( HoleFitPlugin )
...
-- in GHC.Tc.Utils.Constraint, but they refer to ErrCtxt which refers to TcM.
...
data PromotionErr
  ...
  | ConstrainedDataConPE PredType
                     ...
                     --           non-equality contexts] in GHC.Tc.Type
...
-- GHC.Tc.Simplify uses them, and GHC.Tc.Simplify is fairly
...
data TcIdSigInst
  = TISI { sig_inst_sig :: TcIdSigInfo
         ...
         , sig_inst_wcx   :: Maybe TcType
               ...
               -- only from the return value of GHC.Tc.Type.tcAnonWildCardOcc
         }
