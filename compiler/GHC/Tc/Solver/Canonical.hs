...
import GHC.Tc.Unify( swapOverTyVars, metaTyVarUpdateOK, MetaTyVarUpdateResult(..) )
...
Wrinkles:
 ...
 (2) Though it would be sound to do so, we must not mark the rewritten Wanted
     ...
     in GHC.Tc.Utils.Constraint. The problem is about poor error messages. See #11198 for
