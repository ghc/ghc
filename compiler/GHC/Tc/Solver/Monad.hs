...
module GHC.Tc.Solver.Monad (
    ...
    pprEq                                    -- Smaller utils, re-exported from TcM
                                             ...
                                             -- instance matcher in GHC.Tc.Simplify. I am wondering
...
import qualified GHC.Tc.Instantiate as TcM
import GHC.Core.InstEnv
import GHC.Tc.Instance.Family as FamInst
import GHC.Core.FamInstEnv

import qualified GHC.Tc.Monad          as TcM
import qualified GHC.Tc.Utils.Monadic  as TcM
import qualified GHC.Tc.Instance.Class as TcM( matchGlobalInst, ClsInstResult(..) )
import qualified GHC.Tc.Env            as TcM
...
import GHC.Types.Name.RdrName ( GlobalRdrEnv, GlobalRdrElt )
...
rewrite Wanteds] in GHC.Tc.Utils.Constraint), we may miss some opportunities for
...
Hence:
 * In the main simplifier loops in GHC.Tc.Simplify (solveWanteds,
...
-- See Note [Safe Haskell Overlapping Instances Implementation] in GHC.Tc.Simplify
...
See also GHC.Tc.Unify Note [Deeper level on the left] for how we ensure
...
* Each call to 'f' gives rise to
  ...
  See Note [Overview of implicit CallStacks] in GHC.Tc.Evidence
...
-- Getters and setters of GHC.Tc.Env fields
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
--       - xi is flattened (and obeys Note [Almost function-free] in GHC.Tc.Utils)
--
...
-- See Note [Bind new Givens immediately] in GHC.Tc.Utils.Constraint
