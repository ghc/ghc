...
import GHC.Tc.Unify( canSolveByUnification )
...
we keep?  More subtle than you might think!
  ...
  * Constraints coming from the same level (i.e. same implication)
       ...
       (b) Keep the one that has a non-trivial evidence binding.
            ...
            the Ord dictionary.
            Why? See Note [Tracking redundant constraints] in GHC.Tc.Simplify again.
...
--     See GHC.Tc.Utils.Ct invariants.
--
...
To achieve this required some refactoring of GHC.Tc.FunDeps (nicer
now!).
