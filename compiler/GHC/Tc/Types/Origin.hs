...
-- TODO: CtOrigin wasn't immediately explained so I don't know if this handling of HsHole makes sense.
exprCtOrigin (HsHole _ (L _ name)) = OccurrenceOf name -- WAS: Shouldn'tHappenOrigin "hole expression"
