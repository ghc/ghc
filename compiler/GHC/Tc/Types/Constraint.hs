...
We used to invent an Id to hold the erroring expression, and then bind it during
type-checking. Yet this does not support levity-polymorphic out-of-scope identifiers.
See #17812 and typecheck/should_compile/T17812. We thus use the mutable-CoreExpr
