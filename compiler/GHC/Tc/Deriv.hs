...
tcDeriving deriv_infos deriv_decls
  = recoverM (do { g <- getGblEnv
    ...
    do  { -- Fish the "deriving"-related information out of the GHC.Tc.Env
...
deriveStandalone (L loc (DerivDecl _ deriv_ty mb_lderiv_strat overlap_mode))
  = setSrcSpan loc                   $
    ...
    do { traceTc "Standalone deriving decl for" (ppr deriv_ty)
       ; let ctxt = GHC.Tc.Utils.Origin.InstDeclCtxt True
...
function. See, for instance, GHC.Tc.Deriv.Constraints.inferConstraintsCoerceBased.
