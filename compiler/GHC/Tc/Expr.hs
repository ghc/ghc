...
import {-# SOURCE #-}   GHC.Tc.Splice( tcSpliceExpr, tcTypedBracket, tcUntypedBracket )
import THNames( liftStringName, liftName )

import GHC.Hs
import GHC.Tc.Utils.Constraint ( HoleSort(..) )
import GHC.Tc.Syntax
import GHC.Tc.Monad
import GHC.Tc.Unify
import GHC.Types.Basic
import GHC.Tc.Instantiate
import GHC.Tc.Binds           ( chooseInferredQuantifiers, tcLocalBinds )
import GHC.Tc.Sigs            ( tcUserTypeSig, tcInstSig )
import GHC.Tc.Simplify        ( simplifyInfer, InferMode(..) )
...
import GHC.Tc.Env
import GHC.Tc.Arrows
import GHC.Tc.Match
import GHC.Tc.Type
import GHC.Tc.PatSyn          ( tcPatSynBuilderOcc, nonBidirectionalErr )
import GHC.Tc.Pat
  ...
  = ASSERT( notNull rbnds )
    do  { -- STEP -2: typecheck the record_expr, the record to be updated
        ...
        ; let fixed_tvs = getFixedTyVars upd_fld_occs con1_tvs relevant_cons
              ...
              --   c.f. GHC.Tc.Utils.Monadic.newMetaTyVars
...
mk_app_msg fun args = sep [ text "The" <+> text what <+> quotes (ppr expr)
  ...
  where
    ...
    -- See Note [Herald for matchExpectedFunTys] in GHC.Tc.Unify.
...
tcInferFun fun
  = tcInferSigma fun
      -- NB: tcInferSigma; see GHC.Tc.Unify
      -- Note [Deep instantiation of InferResult] in GHC.Tc.Unify
...
just like in GHC.Tc.Binds.decideGeneralisationPlan
...
mixedSelectors _ _ = panic "GHC.Tc.Expr: mixedSelectors emptylists"
