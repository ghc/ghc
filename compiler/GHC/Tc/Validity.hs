...
import GHC.Tc.Env       ( tcInitTidyEnv, tcInitOpenTidyEnv )
...
unambiguous. See Note [Impedance matching] in GHC.Tc.Binds.
...
"tau-tvs" stuff.  This is done in the function 'GHC.Tc.FunDeps.grow'.
-}
...
check_pred_help under_syn env dflags ctxt pred
  ...
  = case classifyPredType pred of
      ...
      EqPred _ _ _      -> pprPanic "check_pred_help" (ppr pred)
              ...
              -- to box such constraints in GHC.Tc.Utils.Type.pickQuantifiablePreds, as described
              -- in Note [Lift equality constraints when quantifying] in GHC.Tc.Utils.Type
...
See also
  ...
  * Note [Checking telescopes] in GHC.Tc.Utils.Constraint discusses how
