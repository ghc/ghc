...
is in the body of boxedMarshalableTyCon in GHC.Tc.Utils.Type. The only members of that
       ...
       ; let
           ...
           -- structure of the foreign type.
             ...
             id                = mkLocalId nm sig_ty
                 ...
                 -- (so GHC.Tc.Syntax.zonkForeignExports ignores it).
