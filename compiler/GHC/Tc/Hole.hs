...
module GHC.Tc.Hole ( findValidHoleFits, tcFilterHoleFits
                    ...
                    -- Re-exported from GHC.Tc.Hole.FitTypes
...
import GHC.Tc.Simplify    ( simpl_top, runTcSDeriveds )
