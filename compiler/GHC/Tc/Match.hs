...
import {-# SOURCE #-}   GHC.Tc.Expr( tcSyntaxOp, tcInferRhoNC, tcInferRho
...
See Note [sig_tau may be polymorphic] in GHC.Tc.Pat.
-}
...
tcMatchLambda :: SDoc -- see Note [Herald for matchExpectedFunTys] in GHC.Tc.Unify
              -> TcMatchCtxt HsExpr
              -> MatchGroup GhcRn (LHsExpr GhcRn)
