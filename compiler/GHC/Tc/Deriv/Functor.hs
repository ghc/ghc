...
gen_Functor_binds loc tycon
  ...
  where
    fmap_name = N (noAnnApiName loc) fmap_RDR
...
gen_Functor_binds loc tycon
  ...
  where
    ...
    -- See Note [Deriving <$]
    replace_name = N (noAnnApiName loc) replace_RDR
...
gen_Foldable_binds loc tycon
  ...
  where
    foldMap_name = N (noAnnApiName loc) foldMap_RDR
...
gen_Foldable_binds loc tycon
  ...
  where
    ...
    foldr_bind = mkRdrFunBind (N (noAnnApiName loc) foldable_foldr_RDR) eqns
    ...
    null_name = N (noAnnApiName loc) null_RDR
...
gen_Traversable_binds loc tycon
  ...
  where
    traverse_name = N (noAnnApiName loc) traverse_RDR
