...
integerFromWord64_RDR, integerFromInt64_RDR :: RdrName
integerFromWord64_RDR = varQual_RDR  gHC_NUM_INTEGER (fsLit "integerFromWord64#")
integerFromInt64_RDR  = varQual_RDR  gHC_NUM_INTEGER (fsLit "integerFromInt64##")
#endif
...
--       Int64#/Word64# will become Integer
...
#if WORD_SIZE_IN_BITS < 64
    , (int64PrimTy,  nlHsApp (nlHsVar integerFromInt64_RDR))
    , (word64PrimTy, nlHsApp (nlHsVar integerFromWord64_RDR))
#endif
    ]
