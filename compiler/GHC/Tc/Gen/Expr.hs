...
disambiguateRecordBinds :: LHsExpr GhcRn -> TcRhoType
                 ...
                 -> TcM [LHsFieldBind GhcTc (Located (AmbiguousFieldOcc GhcTc)) (LHsExpr GhcRn)]
disambiguateRecordBinds record_expr record_rho rbnds res_ty
  ...
  where
    ...
    lookupSelector :: (LHsRecUpdField GhcRn, Name)
                 -> TcM (LHsFieldBind GhcRn (Located (AmbiguousFieldOcc GhcTc)) (LHsExpr GhcRn))
...
tcRecordUpd
        :: ConLike
        -> [TcType]     -- Expected type for each field
        -> [LHsFieldBind GhcTc (Located (AmbiguousFieldOcc GhcTc)) (LHsExpr GhcRn)]
...
tcRecordUpd con_like arg_tys rbinds = fmap catMaybes $ mapM do_bind rbinds
  where
    ...
    do_bind :: LHsFieldBind GhcTc (Located (AmbiguousFieldOcc GhcTc)) (LHsExpr GhcRn)
