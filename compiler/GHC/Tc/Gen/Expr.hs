...
-- in the renamer. See Note [Rebindable Syntax for record dot syntax].
-- This is why we match on 'rupd_flds = Left rbnds' here and panic
-- otherwise.
...
tcExpr (HsOverLabel {})    ty = pprPanic "tcExpr:OverLabel"    (ppr ty)
