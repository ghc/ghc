...
-- splitHsApps takes apart either an HsApp, or an infix OpApp;
-- it returns a Rebuilder which reconstructs the original form.

type family XPass p where
  XPass 'TcpRn   = 'Renamed         -- After renaming
  XPass 'TcpInst = 'Renamed         -- After tcInstFun
  XPass 'TcpTc   = 'Typechecked     -- After typechecking
