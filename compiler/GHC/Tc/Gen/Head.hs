...
addExprCtxt e thing_inside
  = case e of
   ...
   -- TODO(aidylns): can HsUnboundVarRn occur here or was this only about holes/only about unbound non-hole vars?
   -- The HsHole/HsUnboundVarRn special case addresses situations like
   --    f x = _
