...
lhsSigContextSpan :: Sig GhcRn -> ReportRedundantConstraints
...
lhsSigContextSpan (SpecSig _ _ (sig:_) _) = lhsSigTypeContextSpan sig
    -- Just pick the first; not ideal
lhsSigContextSpan _ = NoRRC
