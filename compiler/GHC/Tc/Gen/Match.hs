...
tcStmtCtxt ctx = case ctx of
  (HsDoStmt ListComp) -> HsDoStmt ListComp
  (HsDoStmt MonadComp) -> HsDoStmt MonadComp
  (HsDoStmt (DoExpr mn)) -> HsDoStmt $ DoExpr mn
  (HsDoStmt (MDoExpr mn)) -> HsDoStmt $ MDoExpr mn
  ArrowExpr -> ArrowExpr
  (HsDoStmt GhciStmtCtxt) -> HsDoStmt GhciStmtCtxt
