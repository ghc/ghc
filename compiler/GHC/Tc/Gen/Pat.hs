...
-----------------
tcPats :: HsMatchContext (XRec GhcTc (CtxIdP GhcTc))
       -> [LPat GhcRn]            -- Patterns,
...
tcInferPat :: HsMatchContext (XRec GhcTc (CtxIdP GhcTc)) -> LPat GhcRn
           -> TcM a
...
tcCheckPat :: HsMatchContext (XRec GhcTc (CtxIdP GhcTc))
...
tcCheckPat_O :: HsMatchContext (XRec GhcTc (CtxIdP GhcTc))
...
data PatCtxt
  = LamPat   -- Used for lambdas, case etc
       (HsMatchContext (XRec GhcTc (CtxIdP GhcTc)))
