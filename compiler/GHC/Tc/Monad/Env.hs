...
--
-- The Id is never a DataCon. (Why does that matter? see GHC.Tc.Expr.tcId)
tcLookupId name = do
...
to the environment. Then GHC.Tc.HsType.tcTyVar will find A in the kind
...
-- See Note [Placeholder PatSyn kinds] in GHC.Tc.Binds
