...
import GHC.Tc.Utils     -- Re-export all
...
import {-# SOURCE #-} GHC.Tc.Env    ( tcInitTidyEnv )
...
-- tracks covar usages (see comments on ebv_tcvs in GHC.Tc.Evidence), thus
...
-- See Note [TcLevel assignment] in GHC.Tc.Utils.Type
...
solution: make GHC.Tc.Unify.uType spot manifestly-insoluble constraints.
