...
reportWanteds ctxt tc_lvl (WC { wc_simple = simples, wc_impl = implics
  ...
  = do { traceTc "reportWanteds" (vcat [ text "Simples =" <+> ppr simples
       ...
       ; (ctxt1, cts1) <- tryReporters ctxt_for_insols (report1 warn_inaccessible_flag) tidy_cts
...
mkGivenWarningReporter ctxt cts
  = do { (ctxt, binds_msg, ct) <- relevantBindings True ctxt ct
       ...
       -- If the code was generated by a deriving clause, we don't report this warning.
