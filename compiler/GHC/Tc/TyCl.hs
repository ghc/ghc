  ...
  = setSrcSpan (getSrcSpan con)  $
    ...
    do  { -- Check that the return type of the data constructor
        ...
        ; unless (isNewTyCon tc) $
            ...
            -- the checkNoErrs is to prevent a panic in isVanillaDataCon, which
            -- can fall over if there is a bang on a levity-polymorphic argument
            -- This is #18534, typecheck/should_fail/T18534
