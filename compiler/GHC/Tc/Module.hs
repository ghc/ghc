...
import {-# SOURCE #-} GHC.Tc.Splice ( finishTH, runRemoteModFinalizers )
import GHC.Rename.Splice ( rnTopSpliceDecls, traceSplice, SpliceInfo(..) )
import GHC.Iface.Env     ( externaliseName )
import GHC.Tc.Type
import GHC.Tc.Validity( checkValidType )
import GHC.Tc.Match
import GHC.Tc.Instantiate( deeplyInstantiate )
import GHC.Tc.Unify( checkConstraints )
...
import GHC.Tc.Annotations
import GHC.Tc.Binds
import GHC.Iface.Make   ( coAxiomToIfaceDecl )
import HeaderInfo       ( mkPrelImports )
import GHC.Tc.Defaults
import GHC.Tc.Env
import GHC.Tc.Rule
import GHC.Tc.Foreign
...
import GHC.Tc.TyCl
import GHC.Tc.Deriv.Typeable ( mkTypeableBinds )
...
import Util
import Bag
import GHC.Tc.Instantiate (tcGetInsts)
               ...
               ; setGblEnv tcg_env
                 $ do { -- Process the export list
                      ...
                      ; -- The new type env is already available to stuff
                        ...
                        -- GHC.Tc.Env.setGlobalTypeEnv. It's important that this
...
tcRnExpr hsc_env mode rdr_expr
  = runTcInteractive hsc_env $
    ...
    -- same as of a bound expression (GHC.Tc.Binds.mkInferredPolyId). See Trac
  ...
  = runTcInteractive hsc_env $
    ...
    do { (HsWC { hswc_ext = wcs, hswc_body = rn_type }, _fvs)
       ...
       ; failIfErrsM
        ...
        -- We follow Note [Recipe for checking a signature] in GHC.Tc.Type here
...
getTcPlugins :: DynFlags -> [GHC.Tc.Monad.TcPlugin]
