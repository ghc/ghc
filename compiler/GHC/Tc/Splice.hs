...
import GHC.Driver.Main
        -- These imports are the reason that GHC.Tc.Splice
...
`GHC.Tc.Splice.runTopSplice` and the expression inserted into the AST as normal.
...
like that.  Here's how it's processed:
  ...
  * The TcM monad is an instance of Quasi (see GHC.Tc.Splice), and it implements
...
-- This is a specialised version of GHC.Tc.Monad.Env.tcLookup; specialised mainly in that
