...
-- and those more complicates ones who were moved to module GHC.Tc.EvTerm
...
and the constraint
    [G] g1 :: a~Bool
See #7238 and Note [Bind new Givens immediately] in GHC.Tc.Utils.Constraint
...
3. We default any insoluble CallStacks to the empty CallStack. Suppose
   ...
   (see GHC.Tc.Simplify.simpl_top and GHC.Tc.Simplify.defaultCallStacks)
...
* evVarsOfTerm is used only by GHC.Tc.Simplify.neededEvVars.
