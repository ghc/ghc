...
Thus: skolemise away. cf. Inst.deeplySkolemise and GHC.Tc.Unify.tcSkolemise
 ...
 * Overall instance implication. There is an overall enclosing
   ...
   and superclasses.  See GHC.Tc.Simplify Note [Tracking redundant
   constraints]
...
mk_meth_spec_prags :: Id -> [LTcSpecPrag] -> [LTcSpecPrag] -> TcSpecPrags
        ...
        --     the correct wrapper.
        -- See Note [Handling SPECIALISE pragmas] in GHC.Tc.Binds
