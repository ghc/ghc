...
import GHC.Tc.Monad            ( TcGblEnv, TcLclEnv, TcPluginM
                               , unsafeTcPluginTcM, getEvBindsTcPluginM
                               , liftIO, traceTc )
import GHC.Tc.Utils.Constraint ( Ct, CtLoc, CtEvidence(..), ctLocOrigin )
import GHC.Tc.Utils.Monadic    ( TcTyVar, TcType )
import GHC.Tc.Env              ( TcTyThing )
import GHC.Tc.Evidence         ( TcCoercion, CoercionHole, EvTerm(..)
