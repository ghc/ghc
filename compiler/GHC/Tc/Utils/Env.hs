...
tcLookupKnownKeyGlobal :: HasDebugCallStack => Unique -> TcM TyThing
...
tcLookupKnownKeyClass :: HasDebugCallStack => Unique -> TcM Class
...
tcLookupKnownKeyTyCon :: HasDebugCallStack => Unique -> TcM TyCon
