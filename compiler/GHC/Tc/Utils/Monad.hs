...
Solution: instead of setLclEnv use restoreLclEnv, which keeps the
errors, constraints, and usage info from the /parent context/, setting
everything else from the supplied TcLclEnv.
-}
