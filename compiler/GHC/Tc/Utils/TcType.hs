...
This Note describes typechecker equality, which is a subset of definitional
equality: if two types are equal according to typechecker equality, then they
are also equal according to definitional equality. Typechecker equality is
more finer-grained than definitional equality in two places:
