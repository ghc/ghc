...
module GHC.Tc.Utils.Constraint (
        -- QCInst
...
import {-# SOURCE #-} GHC.Tc.Utils ( TcLclEnv, setLclEnvTcLevel, getLclEnvTcLevel
...
The almost-function-free property is checked by isAlmostFunctionFree in GHC.Tc.Utils.Type.
...
*                                                                      *
                Wanted constraints
     These are forced to be in GHC.Tc.Utils because
...
Bottom line: insolubleWC (called in GHC.Tc.Simplify.setImplicationStatus)
...
data Implication
  = Implic {   -- Invariants for a tree of implications:
      ...
      ic_given  :: [EvVar],      -- Given evidence variables
                                 ...
                                 -- See Invariant (GivenInv) in GHC.Tc.Utils.Type
      ...
      ic_wanted :: WantedConstraints,  -- The wanteds
                                       -- See Invariang (WantedInf) in GHC.Tc.Utils.Type
...
outside the implication in GHC.Tc.Simplify.floatEqualities or
GHC.Tc.Simplify.approximateImplications
