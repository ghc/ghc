...
module GHC.Types.Name.Occurrence (
        ...
        -- ** Derived 'OccName's
        isDerivedOccName,
        mkDataConWrapperOcc, mkWorkerOcc, mkBootIndOcc,
...
-- | The symbol of the static indirection that a defining module emits for a
-- value it also exports through an hs-boot interface; see Note [Boot-exported
-- constructors and pointer tagging] in "GHC.StgToCmm.DataCon".
mkBootIndOcc        = mk_simple_deriv varName  "$bi"
