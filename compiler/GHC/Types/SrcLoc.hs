...
srcSpanStart (GeneratedSrcSpan{}) = UnhelpfulLoc (generatedSrcSpanDetailsFS)
...
srcSpanEnd (GeneratedSrcSpan{}) = UnhelpfulLoc (generatedSrcSpanDetailsFS)
...
generatedSrcSpanDetailsFS :: FastString
generatedSrcSpanDetailsFS = fsLit "<generated>"

pprGeneratedSrcSpanDetails :: SDoc
pprGeneratedSrcSpanDetails = ftext generatedSrcSpanDetailsFS

pprUserSpan :: Bool -> SrcSpan -> SDoc
pprUserSpan _         (UnhelpfulSpan r) = pprUnhelpfulSpanReason r
pprUserSpan _         (GeneratedSrcSpan{}) = pprGeneratedSrcSpanDetails
