...
zipSameShape :: (r -> r -> r) -> KnownShape r -> KnownShape r -> KnownShape r
zipSameShape lub_r (ConSh t1 args1) (ConSh t2 args2)
...
lubTerm (Term tf1 sh1) (Term tf2 sh2) =
  Term (lubTermFlag tf1 tf2) (zipSameShape lubTerm sh1 sh2)
