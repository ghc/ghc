...
data IdInfo
  = IdInfo {
        ...
        -- generate more efficient calling code. See getCallMethod
        -- GHC.StgToCmm.Closure and Note [Conveying CAF-info and LFInfo between
        -- modules] in GHC.StgToCmm.Types.
    }
