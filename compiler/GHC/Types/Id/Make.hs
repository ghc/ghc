...
import GHC.Tc.Utils.Type as TcType
...
-- a splitting operation (cf, GHC.Tc.Pat.tcConPat).
...
Historical note:
    In GHC.Tc.Expr we used to need a special typing rule for 'seq', to handle calls
