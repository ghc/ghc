...
import {-# SOURCE #-}   GHC.Tc.Utils.Type( TcTyVarDetails, pprTcTyVarDetails, vanillaSkolemTv )
...
mkTcTyVar name kind details
  = -- NB: 'kind' may be a coercion kind; cf, 'GHC.Tc.Utils.Monadic.newMetaCoVar'
...
-- See Note [TcTyVars in the typechecker] in GHC.Tc.Utils.Type
