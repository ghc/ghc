...
data Message
  ...
  | InternalMCDiagnostic SrcSpan Severity ResolvedDiagnosticReason (Maybe DiagnosticCode) SDoc
...
pattern MCDiagnostic span severity reason code doc <- InternalMCDiagnostic span severity reason code doc
