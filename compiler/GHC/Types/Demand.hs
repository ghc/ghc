...
data SubDemand
  ...
  --
  -- We only really use 'Poly' with 'C_10' (bottom), 'C_00' (absent) and
  -- 'C_0N' (top), but it's simpler to treat it uniformly than to have a
  -- special constructor for each of the three cases.
  | Call !Card !SubDemand
