...
data SubDemand
  ...
  -- see Note [Do not rewrite CS(S) to S].
...
-- mkCall C_1N sd@(Poly Boxed C_1N) = sd -- See Note [Do not rewrite CS(S) to S]
...
Note [Do not rewrite CS(S) to S]
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
This problem is tracked in #21085. That ticket establishes that we have
