...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SG: I find this Note to be in very bad shape, and it is mostly redundant with
Note [Understanding DmdType and StrictSig], except that it focuses on Divergence
and higher-order scenarios.
...
Now consider a function h with signature "<C(S)>", and the expression
  e1 = h b1
now h puts a strictness demand of "C(S)" onto its argument, and the demand
transformer turns it into
  <S>b
Now the Divergence "b" does apply to us, even though under head strictness
"b1 `seq` ()" it does not diverge, and we do not see anything being
syntactically passed to b1.
