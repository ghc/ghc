...
mkLitInt8Wrap i = LitNumber LitNumInt64 (toInteger (fromIntegral i :: Int8))
...
mkLitWord8Wrap i = LitNumber LitNumInt64 (toInteger (fromIntegral i :: Word8))
...
mkLitInt16Wrap i = LitNumber LitNumInt64 (toInteger (fromIntegral i :: Int16))
...
mkLitWord16Wrap i = LitNumber LitNumInt64 (toInteger (fromIntegral i :: Word16))
...
mkLitInt32Wrap i = LitNumber LitNumInt64 (toInteger (fromIntegral i :: Int32))
...
mkLitWord32Wrap i = LitNumber LitNumInt64 (toInteger (fromIntegral i :: Word32))
