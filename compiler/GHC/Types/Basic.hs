...
instance Binary InlineSpec where
    ...
    get bh = do h <- getByte bh
                ...
                case h of
                  ...
                  _ -> return (NoInline (SourceText s))
...
pprInline' emptyInline (InlinePragma
    ...
    where
      ...
      pp_act (Inline    (SourceText _ ))  AlwaysActive = empty
      pp_act (NoInline  (SourceText _ ))  NeverActive  = empty
      pp_act (Inlinable (SourceText _ ))    act        = ppr act
