...
module GHC.HsToCore.Splice( dsBracket ) where
...
import GHC.Hs
import PrelNames
-- To avoid clashes with GHC.HsToCore.Splice.varName we must make a local alias
...
globalVar name
  ...
  where
      ...
      mk_varg | OccName.isDataOcc name_occ = mkNameG_dName
              ...
              | otherwise                  = pprPanic "GHC.HsToCore.Splice.globalVar" (ppr name)
