...
module GHC.HsToCore.PmCheck.Oracle (
        ...
        pattern PmNotBotCt, pattern PmFalseCt,
...
1. When compiling the PmCon guard in 'pmCompileTree', add PmFalseCt instead of
   PmBotCt to the divergent set, because the match will never diverge.
...
data TmCt
  ...
  | TmFalseCt
  -- ^ @TmFalseCt@ is the unsatisfiable constraint.
...
pattern PmFalseCt :: PmCt
pattern PmFalseCt           = PmTmCt TmFalseCt
