...
We achieves great benefit with a very simple implementation.
There are caveats, though:
  ...
  (A) Putting potentially failing guards /after/ the
      ...
      That *is* fixable, although we pay with a much more complicated
      implementation.
  (B) If the programmer puts a 'considerAccessible' marker on an accessible
      ...
      here, but it won't be as simple as it is now.
-}
