...
mkCastVar uq ty = mkSysLocal (fsLit "cst_sum") uq UnmatchableTy ManyTy ty
...
ubxSumRubbishArg FloatSlot       = StgLitArg (mkLitFloat  0)
ubxSumRubbishArg DoubleSlot      = StgLitArg (mkLitDouble 0)
