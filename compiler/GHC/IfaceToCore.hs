...
import GHC.StgToCmm.Closure (might_be_a_function)
...
tcLFInfo :: Type -> IfaceLFInfo -> IfL LambdaFormInfo
tcLFInfo ty lfi = case lfi of
    ...
    IfLFUnknown ->
      return (LFUnknown (might_be_a_function ty))
