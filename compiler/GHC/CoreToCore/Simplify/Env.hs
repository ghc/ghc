...
module GHC.CoreToCore.Simplify.Env (
        -- * The simplifier mode
        ...
        GHC.CoreToCore.Simplify.Env.extendTvSubst,
        GHC.CoreToCore.Simplify.Env.extendCvSubst,
...
import GHC.CoreToCore.Monad           ( SimplMode(..) )
import GHC.Core
