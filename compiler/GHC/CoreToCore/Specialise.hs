...
module GHC.CoreToCore.Specialise ( specProgram, specUnfolding ) where
...
import State
import UniqDFM
import GHC.Core.TyCoRep (TyCoBinder (..))
           ...
           {    -- Figure out the type of the specialised function
             let body = mkLams unspec_bndrs rhs_body'
                 ...
                 (lam_extra_args, app_args)     -- See Note [Specialisations Must Be Lifted]
                   | isUnliftedType body_ty     -- C.f. WorkWrapLib.mkWorkerArgs
                   , not (isJoinId fn)
           ...
           ; let
                ...
                (spec_inl_prag, spec_unf)
                  ...
                  = (neverInlinePragma, noUnfolding)
                        -- See Note [Specialising imported functions] in GHC.Core.OccurAnal
