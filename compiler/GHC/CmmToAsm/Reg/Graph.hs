...
regAlloc config regsFree slotsFree slotsCount code cfg
 = do
        ...
        --       target architecture. Would prefer to determine this from config.
...
regAlloc_spin config spinCount triv regsFree slotsFree slotsCount debug_codeGraphs code cfg
 = do
        ...
        let dump = or
                [ configDumpRegAllocStages config
                , configDumpAsmStats       config
                , configDumpAsmConflicts   config
                ]
