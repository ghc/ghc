  ...
  where
    ...
    intComparison cond true false r1_lo r2_lo =
      case cond of
        ...
        GEU -> cmpGE
        -- [x > y] == ![x >= y]
        GTT -> intComparison GE  false true r1_lo r2_lo
        GU  -> intComparison GEU false true r1_lo r2_lo
        -- [x <= y] == [y >= x]
        LE  -> intComparison GE  false true r2_lo r1_lo
        LEU -> intComparison GEU false true r2_lo r1_lo
        -- [x < y] == ![x >= x]
        LTT -> intComparison GE  true false r1_lo r2_lo
        LU  -> intComparison GEU true false r1_lo r2_lo
      where
