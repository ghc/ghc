...
data DriverMessage where
  ...
  {-| DriverModuleNotFound occurs if a module 'A' is defined in a file with a different name.
      The first field is the name written in the source code; the second argument is the name
  ...
  {-| DriverFileModuleNameMismatch occurs if a module 'A' is defined is a file with a different name.
      The first argument is the /actual/ name, the second argument the expected one.
