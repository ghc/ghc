...
-- | Constructs a new 'MsgEnvelope' out of 'DriverMessage'.
...
mkDriverMessage :: DynFlags -> SrcSpan -> DriverMessage -> MsgEnvelope DriverMessage
mkDriverMessage dflags locn msg = mkMsgEnvelope dflags locn alwaysQualify msg
...
mkDriverErrorMessage :: SrcSpan -> DriverMessage -> MsgEnvelope DriverMessage
mkDriverErrorMessage locn msg =
  let panicMsg = "ghcDriverErrorMessage called on a DriverMessage which DiagnosticReason was not ErrorWithoutFlag"
  in mkDriverMessage (panic panicMsg) locn msg
