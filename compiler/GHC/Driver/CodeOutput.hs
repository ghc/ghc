...
codeOutput dflags unit_state this_mod filenm location foreign_fps pkg_deps genForeignStubs
  cmm_stream
  =
    do  {
...
-- | Generate code to initialise info pointer origin table.
