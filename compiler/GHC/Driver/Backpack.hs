...
withBkpSession cid insts deps session_type do_this = do
    ...
    let cid_fs = unitFS (indefUnit cid)
        ...
        enable_iface_write_maybe dflags = 
            ...
            case session_type of
              ...
              -- indefinite packages.
              TcSession
                | backend dflags /= NoBackend -> flip gopt_set Opt_WriteInterface
                | otherwise                   -> id
              CompSession -> id
              ExeSession  -> id
        ...
        mk_temp_dflags unit_state dflags = enable_iface_write_maybe dflags $ dflags
