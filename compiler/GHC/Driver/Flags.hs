...
--
-- One flag may have several names because of US/UK spelling or abbreviations...
-- The first one is the "preferred one" that will be displayed in warning messages.
...
warnFlagNames wflag = case wflag of
  ...
  Opt_WarnMissingLocalSignatures            -> "missing-local-signatures" :| ["missing-local-sigs"]
  ...
  Opt_WarnMissingExportedSignatures         -> "missing-exported-signatures" :| ["missing-exported-sigs"]
