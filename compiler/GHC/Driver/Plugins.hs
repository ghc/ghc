...
import qualified GHC.Tc.Utils
import GHC.Tc.Utils ( TcGblEnv, IfM, TcM, tcg_rn_decls, tcg_rn_exports  )
import GHC.Tc.Hole.FitTypes ( HoleFitPluginR )
import GHC.Hs
...
type TcPlugin = [CommandLineOption] -> Maybe GHC.Tc.Utils.TcPlugin
