...
module GHC.Driver.Pipeline.Monad (
  ...
  , setDynFlags, setModLocation, setForeignOs, setHomeModInfo
  , pipeStateDynFlags, setPlugins
  ) where
...
data PipeState = PipeState {
       ...
       maybe_hmi :: Maybe HomeModInfo
         -- ^ HMI generated by HscOut phase. Only available after the
         -- phase runs.
  }
...
setHomeModInfo :: HomeModInfo -> CompPipeline ()
setHomeModInfo hmi = P $ \_env state -> return (state{ maybe_hmi = Just hmi }, ())
