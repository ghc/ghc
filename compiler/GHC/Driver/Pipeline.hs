...
getLocation src_flavour mod_name = do
    ...
    case maybe_loc of
        ...
        -- TODO: This is a hack to support the .o_dyn creation in case of
        -- -fno-code and TemplateHaskell. This API should not be doing a
        -- patching of existing ModLocation present in the PipeState, it should
        -- happen at the point PipeState is being set.
      Just l -> do
        let location1 = l
