...
mkInteractiveHscEnv hsc_env = hsc_env
    { hsc_internalUnitEnv = Map.insert interactiveInstalledUnitId interactiveInternalUnitEnv $ hsc_internalUnitEnv hsc_env
    }
  where
...
data HscEnv
  = HscEnv {
        ...
        hsc_internalUnitEnv :: Map.Map InstalledUnitId InternalUnitEnv,
...
data Target
  = Target {
      ...
      targetPackage      :: InstalledUnitId,   -- ^ target's package
