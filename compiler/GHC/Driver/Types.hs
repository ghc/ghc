...
module GHC.Driver.Types (
        ...
        ExtendedModSummary, emsModSummary, emsInstantiatedUnits,
        emsModuleNode, toExtendedModSummary,
...
-- topological sort. It's use is somewhat dubious: when '@ModuleGraphNode@' was
