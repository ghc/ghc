...
could only do that if the extension field was strict.
-}
...
name 'getField' is whatever in-scope name that name is.
...
and RebindableSyntax is enabled 'getField' and 'setField' are whatever
in-scope names they are.
