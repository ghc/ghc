...
ppr_expr (HsTypedSplice ext e)   =
    case ghcPass @p of
      ...
      GhcRn | HsTypedSpliceNested n <- ext -> pprTypedSplice (Just n) e
      GhcRn | HsTypedSpliceTop {} <- ext -> pprTypedSplice Nothing e
...
-- | Information about a user splice, discovered by the renamer
