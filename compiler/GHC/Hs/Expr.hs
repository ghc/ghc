...
mkRnSyntaxExpr name = SyntaxExprRn $ HsVar Bound $ noLocA name
...
type instance XHole          GhcPs = NoExtField
...
ppr_expr (HsHole _ (L _ v))  = pprPrefixOcc v
...
ppr_infix_expr (HsHole _ (L _ v))   = Just (pprInfixOcc v)
