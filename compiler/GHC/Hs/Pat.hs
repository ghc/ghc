...
type instance XViewPat GhcRn = IsPatInvertible
...
-- | The information of whether a pattern is definitely invertible,
-- or possibly not.
data IsPatInvertible = InvertiblePat | PossiblyNotInvertiblePat
