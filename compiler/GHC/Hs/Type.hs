...
-- MODS_TODO can be just NoExtField
data EpLinearArrow
...
type instance XExplicitMult      _ GhcPs = EpUniToken "->" "→"
...
pprHsArrow (HsLinearArrow _ _)     = pprArrowWithMultiplicity visArgTypeLike (Left True)
