...
deriving instance Data (HsTupArgOf GhcPs (LocatedA (HsExpr GhcPs)))
deriving instance Data (HsTupArgOf GhcRn (LocatedA (HsExpr GhcRn)))
deriving instance Data (HsTupArgOf GhcTc (LocatedA (HsExpr GhcTc)))
deriving instance Data (HsTupArgOf GhcPs (LocatedA (HsType GhcPs)))
deriving instance Data (HsTupArgOf GhcRn (LocatedA (HsType GhcRn)))
deriving instance Data (HsTupArgOf GhcTc (LocatedA (HsType GhcTc)))
