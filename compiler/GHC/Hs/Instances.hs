...
-- deriving instance (DataIdLR p p) => Data (LHsQTyVisVars p)
deriving instance Data (LHsQTyVisVars GhcPs)
...
deriving instance Data (HsTyVarTermBndr GhcRn)
deriving instance Data (HsTyVarTermBndr GhcTc)
