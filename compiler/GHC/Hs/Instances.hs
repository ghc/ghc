...
deriving instance Data (HsArrowOf [HsModifier GhcPs] GhcPs)
deriving instance Data (HsArrowOf [HsModifier GhcRn] GhcRn)
deriving instance Data (HsArrowOf [HsModifier GhcTc] GhcTc)
