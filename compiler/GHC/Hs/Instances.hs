...
-- deriving instance DataIdLR p p => Data (ConGADTBody p)
deriving instance Data (ConGADTBody GhcPs)
deriving instance Data (ConGADTBody GhcRn)
deriving instance Data (ConGADTBody GhcTc)

-- deriving instance DataIdLR p p => Data (PrefixConGADTBody p)
deriving instance Data (PrefixConGADTBody GhcPs)
deriving instance Data (PrefixConGADTBody GhcRn)
deriving instance Data (PrefixConGADTBody GhcTc)
