...
-- deriving instance (DataIdLR p p,Data pat,Data body) => Data (MatchGroup p pat body)
deriving instance Data (MatchGroup GhcPs (LocatedA (Pat GhcPs)) (LocatedA (HsExpr GhcPs)))
deriving instance Data (MatchGroup GhcRn (LocatedA (Pat GhcRn)) (LocatedA (HsExpr GhcRn)))
deriving instance Data (MatchGroup GhcTc (LocatedA (Pat GhcTc)) (LocatedA (HsExpr GhcTc)))
deriving instance Data (MatchGroup GhcPs (LocatedA (Pat GhcPs)) (LocatedA (HsCmd GhcPs)))
deriving instance Data (MatchGroup GhcRn (LocatedA (Pat GhcRn)) (LocatedA (HsCmd GhcRn)))
deriving instance Data (MatchGroup GhcTc (LocatedA (Pat GhcTc)) (LocatedA (HsCmd GhcTc)))

-- deriving instance (DataIdLR p p,Data pat,Data body) => Data (Match      p pat body)
deriving instance Data (Match GhcPs (LocatedA (Pat GhcPs)) (LocatedA (HsExpr GhcPs)))
deriving instance Data (Match GhcRn (LocatedA (Pat GhcRn)) (LocatedA (HsExpr GhcRn)))
deriving instance Data (Match GhcTc (LocatedA (Pat GhcTc)) (LocatedA (HsExpr GhcTc)))
deriving instance Data (Match GhcPs (LocatedA (Pat GhcPs)) (LocatedA (HsCmd GhcPs)))
deriving instance Data (Match GhcRn (LocatedA (Pat GhcRn)) (LocatedA (HsCmd GhcRn)))
deriving instance Data (Match GhcTc (LocatedA (Pat GhcTc)) (LocatedA (HsCmd GhcTc)))
