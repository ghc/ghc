...
-- deriving instance (DataIdLR p p,Data body) => Data (MatchGroup1 p body)
deriving instance (Data body) => Data (MatchGroup0 GhcPs body)
deriving instance (Data body) => Data (MatchGroup0 GhcRn body)
deriving instance (Data body) => Data (MatchGroup0 GhcTc body)
...
-- deriving instance (DataIdLR p p,Data body) => Data (Match      p body)
deriving instance (Data body) => Data (Match0     GhcPs body)
deriving instance (Data body) => Data (Match0     GhcRn body)
deriving instance (Data body) => Data (Match0     GhcTc body)
