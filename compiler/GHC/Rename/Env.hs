...
lookupRecFieldOcc mb_con rdr_name
  ...
  = do { let lbl = FieldLabelString . fastStringToTextUTF8 . occNameFS $ rdrNameOcc rdr_name
    ...
    membership
      = sortMembership $
        map
          ...
          . FieldLabelString . fastStringToTextUTF8 . occNameFS . rdrNameOcc . unLoc . getFieldUpdLbl )
          rbinds
