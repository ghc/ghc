...
needJoin _ctxt _monad_names [] = (False, [])  -- we're in an ApplicativeArg
needJoin ctxt monad_names [L loc (LastStmt f e _ t)]
...
needJoin ctxt _monad_names stmts = (True, stmts)
