...
mkExprInScopeSet e = mkInScopeSet $ fvVarSet $ closeOverTypes $ exprFVs e

closeOverTypes :: VarSet -> FV
closeOverTypes vars = mapUnionFV (tyCoFVsrsOfType . varType) vars `unionFV` FV.mkFVs vars
