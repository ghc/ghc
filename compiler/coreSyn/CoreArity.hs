...
mkArityWrapper bndr (FunTildeTy _ t2) =
...
mkArityWorker (Var {}) = undefined
mkArityWorker (Lit {}) = undefined
mkArityWorker (App {}) = undefined
mkArityWorker (Lam {}) = undefined
mkArityWorker (Let {}) = undefined
mkArityWorker (Case {}) = undefined
