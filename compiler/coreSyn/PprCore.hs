...
pprCoreExpr
  :: ( HasPprConfig r
     ...
     , OutputableBndr b, OutputableBndrNeedsOfConfig' b r
     )
  => Expr b  -> SDoc' r
...
pprTopBinds
  :: ( HasPprConfig r
     ...
     , HasPackageState r
     , HasCoreDebugSuppress r
     , OutputableBndr a, OutputableBndrNeedsOfConfig' a r
     )
...
instance Outputable b => OutputableBndr (TaggedBndr b) where
  type OutputableBndrNeedsOfConfig (TaggedBndr b) = NoConstraint
...
instance Outputable UnfoldingGuidance where
    type OutputableNeedsOfConfig UnfoldingGuidance = NoConstraint
...
instance Outputable UnfoldingSource where
  type OutputableNeedsOfConfig UnfoldingSource = NoConstraint
