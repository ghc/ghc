...
-- dependencies.
--
-- For the documentation of the combinators see
-- <http://hackage.haskell.org/package/lens lens> package. This module uses the
-- same vocabulary.
--
-- This stop-gap stub was taking from Cabal. But arguably both packages ought to
-- use the <http://hackage.haskell.org/package/microlens microlens> package.
module Lens (
    -- * Types
    Lens,
    Lens',
...
-- $development
--
-- We cannot depend on @template-haskell@, because ghc is a boot library.
...
--
-- > :l libraries/Cabal/generics-sop-lens.hs
--
