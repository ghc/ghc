...
.. ghc-flag:: -ddump-stg
    :shortdesc: *(deprecated)* Alias for :ghc-flag:`-ddump-stg-init`
    :type: dynamic

    Alias for :ghc-flag:`-ddump-stg-init`. Deprecated in favor of more explicit
    flags: :ghc-flag:`-ddump-stg-init`, :ghc-flag:`-ddump-stg-final`, etc.
