...
However this is considered an implementation detail and code relying
on this behaviour should use one of the interfaces provided in :base-ref:`Control.Concurrent.`
