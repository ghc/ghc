...
* Upgraded Hash function for faster linker operations.

* Changed hashing function for interface files from MD5 to xxHash.
  xxHash is multiple factors faster than MD5.
