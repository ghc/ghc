...
Modules using unboxed tuples or sums will automatically enable :ghc-flag:`-fobject-code`
    ...
    .. ghc-flag:: -fobject-code-if-unboxed
        :shortdesc: When this flag is set, modules using unboxed tuples or 
                    sums and all modules they depond on will enable 
    ...
    When this flag is set, GHCi will compile these 
    modules to object code instead of bytecode.
    ...
    *really* want to compile
    ...
    Using the :ghc-flag:`-fobject-code-if-unboxed` flag outside GHCi has no effect.
