...
- Structural errors were added to GHCi and assigned error codes, analogous to GHCs
  diagnostics. This change will not be backwards compatible by tools that parse the error
  messages that GHCi emits (:ghc-ticket:`23338`).
