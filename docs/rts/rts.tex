...
@STATIC_CHAR@ and @STATIC_INT@ closures is turned off(?) if this is
...
\item @CONSTR_STATIC_INT@.  A dynamically-allocated heap object that
...
\item @CONSTR_STATIC_CHAR@:  same deal, but for @Char@.
...
\item
  ...
  This lets us drop CONST closures and STATIC_CHAR closures (assuming we
