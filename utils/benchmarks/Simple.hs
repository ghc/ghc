...
import qualified GHC.Event.TimerManager as ET (TimerManager, new, registerTimeout)
import qualified GHC.Event.Manager as EM (FdKey, loop, keyFd, new, registerFd,
                                            evtRead, evtWrite)
