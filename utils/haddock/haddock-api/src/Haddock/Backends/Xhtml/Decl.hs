      ...
      , con_mb_cxt = cxt
        ...
        let context = fromMaybeContext cxt
         ...
         in case det of
              ...
              PrefixCon _ args ->
                ( header_ <+> hsep (ppOcc : map (ppLParendType unicode qual HideEmptyContexts . hsConFieldSpecToHsTypeNoMult) args)
                , noHtml
                , noHtml
                )
              ...
              InfixCon arg1 arg2 ->
                ( header_
                    <+> hsep
                      [ ppLParendType unicode qual HideEmptyContexts (hsConFieldSpecToHsTypeNoMult arg1)
                      , ppOccInfix
                      , ppLParendType unicode qual HideEmptyContexts (hsConFieldSpecToHsTypeNoMult arg2)
                      ]
                , noHtml
                , noHtml
                )
           ...
           in case det of
                ...
                PrefixCon _ args
                  ...
                  | otherwise ->
                      hsep
                        [ header_ <+> ppOcc
                        , hsep (map (ppLParendType unicode qual HideEmptyContexts . hsConFieldSpecToHsTypeNoMult) args)
                        , fixity
                        ]
                -- Record constructor, e.g. 'Identity { runIdentity :: a }'
                ...
                InfixCon arg1 arg2
                  ...
                  | otherwise ->
                      hsep
                        [ header_ <+> ppLParendType unicode qual HideEmptyContexts (hsConFieldSpecToHsTypeNoMult arg1)
                        , ppOccInfix
                        , ppLParendType unicode qual HideEmptyContexts (hsConFieldSpecToHsTypeNoMult arg2)
                        , fixity
                        ]
...
ppRecFieldMultAnn :: Unicode -> Qualification -> HsConFieldSpec DocNameI -> Html -> Html
