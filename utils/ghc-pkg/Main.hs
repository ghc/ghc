...
instance Cabal.Parsec GlobPackageIdentifier where
  parsec = (ExactPackageIdentifier <$> Cabal.parsec) <|>
           (GlobPackageIdentifier <$> Cabal.parsec
                                  <* Cabal.char '-' <* Cabal.char '*')
...
readGlobPkgId str = parseCheck str "package identifier"
