...
ppType (TyF s d) = "(mkFunTy COmega (" ++ ppType s ++ ") (" ++ ppType d ++ "))" -- TODO: arnaud: maybe primops are allowed to have linear types too
ppType (TyC s d) = "(mkFunTy COmega (" ++ ppType s ++ ") (" ++ ppType d ++ "))" -- TODO: arnaud: maybe primops are allowed to have linear types too
