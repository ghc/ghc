...
tt :: IO ()
tt = testOneFile "/home/alanz/mysrc/git.haskell.org/ghc/_build/bindist/ghc-8.11.0.20200518-x86_64-unknown-linux/lib"
  "Test.hs"
...
testOneFile libdir fileName = do
       ...
       let
         origAst = showSDoc unsafeGlobalDynFlags
                     $ showAstData NoBlankSrcSpan NoBlankApiAnnotations
                                                         (pm_parsed_source p)
