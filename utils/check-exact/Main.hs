...
addHiding1 _libdir (L l p) = do
  let doTransform = do
        let
          ...
          v1 = L (addComma $ noAnnSrcSpanDP0) (IEVar Nothing (L noAnnSrcSpanDP0 (IEName noExtField ns_spec n1)) Nothing)
          v2 = L (           noAnnSrcSpanDP0) (IEVar Nothing (L noAnnSrcSpanDP0 (IEName noExtField ns_spec n2)) Nothing)
