...
languageOptions =
  ...
  , flag { flagName = "-fomit-type-family-coercions"
         , flagDescription =
           "Remove big coercions generated by reducing type families during "++
           "type checking. Should speed up the compilation of code "++
           "heavily using type-level computation."
         , flagType = DynamicFlag
         }
