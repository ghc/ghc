...
more _root directories_. A root directory in this case is a directory
under which the testsuite driver will be looking for `.T` files (usually
called `all.T`), where our tests are declared.
