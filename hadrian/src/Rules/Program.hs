...
buildProgram bin ctx@(Context{..}) rs = do
  ...
  --    ../.build/GL-16400_prog_so_default/stage1/libraries/haskeline/build/libHShaskeline-0.7.5.0-ghc8.9.0.20190430.so
  -- but when building the program, we link against the *ghc-pkg registered* library e.g.
  --    ../.build/GL-16400_prog_so_default/stage1/lib/x86_64-linux-ghc-8.9.0.20190430/libHShaskeline-0.7.5.0-ghc8.9.0.20190430.so
