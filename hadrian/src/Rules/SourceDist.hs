...
prepareTree dest = do
  ...
  where
    ...
    alexHappyFiles =
        ...
        , (Stage0, compiler,      "GHC/Builtin/PrimOps.hs-prim",    "GHC/Builtin/PrimOps.hs")
        , (Stage0, compiler,      "GHC/Builtin/Types/Prim.hs-prim", "GHC/Builtin/Types/Prim.hs")
        , (Stage0, compiler,      "GHC/Builtin/Names.hs-prim",      "GHC/Builtin/Names.hs")
        , (Stage0, ghcPrim,       "GHC/Prim.hs-prim",               "GHC/Prim.hs")
        , (Stage0, ghcPrim,       "GHC/PrimopWrappers.hs-prim",     "GHC/PrimopWrappers.hs")
