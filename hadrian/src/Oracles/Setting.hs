module Oracles.Setting (
    ...
    libsuf, ghcVersionStage, shPath, perStageTarget, crossStage, queryTarget, queryPerStageTargetSpec,
    isHostStage,
...
isWasmTarget :: Stage -> Action Bool
isWasmTarget stage = anyTargetArch stage [ArchWasm32]
