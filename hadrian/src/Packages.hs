...
module Packages (
    ...
    ghcCompact, ghcConfig, ghcHeap, ghcJobserver, ghci, ghciWrapper, ghcPkg, ghcPrim, haddock, haskeline,
...
ghcPackages =
    ...
    , compareSizes, compiler, containers, deepseq, deriveConstants, directory
    , exceptions, filepath, genapply, genprimopcode, ghc, ghcBignum, ghcBoot, ghcBootTh
    , ghcCompact, ghcConfig, ghcHeap, ghcJobserver, ghci, ghciWrapper, ghcPkg, ghcPrim, haddock, haskeline, hsc2hs
...
ghcJobserver        = util "ghc-jobserver"
ghci                = lib  "ghci"
