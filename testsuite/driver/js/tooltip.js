...
setCustomTooltip = function(chartInput, extraTextByLabel) {
    ...
    // chartInput.options.tooltips.callbacks = chartInput.options.tooltips.callbacks || {};
    // chartInput.options.tooltips.callbacks.label = function (tooltipItem, data) {
    //     var label = data.datasets[tooltipItem.datasetIndex].label || '';
    //     if (label) {
    //         label += '<br />\n\n<br />' + escapeHtml(extraTextByLabel[label]);
    //     }
    //     return label;
    // }
