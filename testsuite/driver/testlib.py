...
def collect_compiler_stats(metric='all',deviation=20):
    # Compiler stats on Windows are currently completely unreliable. See #23757.
    # I don't want to simply *skip* performance tests, because we may be able to
    # use the variation as a measure of the runner stability. For that reason I
    # will simply override the allowed deviation to a huge number.
    if opsys('mingw32'):
        deviation = 1000
