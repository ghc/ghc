...
def collect_compiler_stats(metric='all',deviation=20):
    """
    Collect metrics from compilation. Note that tests using this may also
    want to use `no_lint` as well to ensure that you don't measure
    linting performance when linting is enabled.
    """
