...
from testutil import strip_quotes, lndir, link_or_copy_file, passed, failBecause
...
def _collect_stats(name, opts, metric, deviation, is_compiler_stats_test=False):
    ...
    # TODO do we need to filter for environmet and way etc.?
    ...
    if range_fields:
        ...
        for (metric, range_val_dev) in range_fields.items():
            ...
            if field_match == None:
                ...
                t.metrics.append(metric_dict(name, way, metric, actual_val))
...
def summary(t, file, short=False, color=False):
    ...
    if color:
        ...
        if len(t.unexpected_failures) > 0 or \
            ...
            color_start = '\033[1m\033[43m\033[31m'
        else:
            color_start = '\033[1m\033[32m'

    file.write(color_start + 'SUMMARY' + color_end + ' for test run started at '
