...
parser.add_argument("--broken-test", action="append", help="a test name to mark as broken for this run")
...
config.broken_tests |= {TestName(t) for t in args.broken_tests}
