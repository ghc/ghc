...
class TestOptions:
   def __init__(self):
       ...
       # Is this test a Haddock perf test? Those don't actually
       # compile or run any Haskell program, they inspect
       # timing files generated by one of the build systems,
       # all stored in the directory pointed to by
       # config.stats_files_dir.
       self.is_haddock_stats_test = False
...
# in addition to passing the `haddock_stats_test` modifier.
