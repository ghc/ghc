...
worker functions that extract declaring and referencing ocurrences
...
subterms (via gmapQ) and the names being referred to at the root of
the present term, but subtract all the names that are declared at
the roo.
