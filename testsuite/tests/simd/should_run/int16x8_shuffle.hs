...
main = do
  ...
  test (0, 2, 4, 6, 8, 10, 12, 14) $ \a b -> shuffleInt16X8# a b (# 0#, 2#, 4#, 6#, 8#, 10#, 12#, 14# #)
  ...
  test (0, 8, 2, 10, 4, 12, 6, 14) $ \a b -> shuffleInt16X8# a b (# 0#, 8#, 2#, 10#, 4#, 12#, 6#, 14# #)
  ...
  test (1, 0, 3, 2, 5, 4, 7, 6) $ \a b -> shuffleInt16X8# a b (# 1#, 0#, 3#, 2#, 5#, 4#, 7#, 6# #)
  ...
  test (1, 3, 5, 7, 9, 11, 13, 15) $ \a b -> shuffleInt16X8# a b (# 1#, 3#, 5#, 7#, 9#, 11#, 13#, 15# #)
  ...
  test (1, 9, 3, 11, 5, 13, 7, 15) $ \a b -> shuffleInt16X8# a b (# 1#, 9#, 3#, 11#, 5#, 13#, 7#, 15# #)
  ...
  test (3, 2, 1, 0, 7, 6, 5, 4) $ \a b -> shuffleInt16X8# a b (# 3#, 2#, 1#, 0#, 7#, 6#, 5#, 4# #)
  ...
  test (8, 0, 10, 2, 12, 4, 14, 6) $ \a b -> shuffleInt16X8# a b (# 8#, 0#, 10#, 2#, 12#, 4#, 14#, 6# #)
  ...
  test (8, 10, 12, 14, 0, 2, 4, 6) $ \a b -> shuffleInt16X8# a b (# 8#, 10#, 12#, 14#, 0#, 2#, 4#, 6# #)
  ...
  test (9, 1, 11, 3, 13, 5, 15, 7) $ \a b -> shuffleInt16X8# a b (# 9#, 1#, 11#, 3#, 13#, 5#, 15#, 7# #)
  ...
  test (9, 8, 11, 10, 13, 12, 15, 14) $ \a b -> shuffleInt16X8# a b (# 9#, 8#, 11#, 10#, 13#, 12#, 15#, 14# #)
  ...
  test (9, 11, 13, 15, 1, 3, 5, 7) $ \a b -> shuffleInt16X8# a b (# 9#, 11#, 13#, 15#, 1#, 3#, 5#, 7# #)
  ...
  test (11, 10, 9, 8, 15, 14, 13, 12) $ \a b -> shuffleInt16X8# a b (# 11#, 10#, 9#, 8#, 15#, 14#, 13#, 12# #)
...
main = do
  let fixedCases = [[i,i,i,i,i,i,i,i] | i <- [0..15]]
        ...
        ++ [[0,8,1,9,2,10,3,11]
           ...
           ,[4,12,5,13,6,14,7,15]
           ,[12,4,13,5,14,6,15,7]
           ,[3,2,1,0,7,6,5,4] -- Arm REV64
           ,[1,0,3,2,5,4,7,6] -- Arm REV32
           ,map (+8) [3,2,1,0,7,6,5,4] -- Arm REV64
           ,map (+8) [1,0,3,2,5,4,7,6] -- Arm REV32
           ,[0,2..14] -- Arm UZP1
           ,[1,3..15] -- Arm UZP2
           ,concat [[i,8+i] | i <- [0,2,4,6]] -- Arm TRN1
           ,concat [[i,8+i] | i <- [1,3,5,7]] -- Arm TRN2
           ,[8,10,12,14,0,2,4,6] -- Arm UZP1
           ,[9,11,13,15,1,3,5,7] -- Arm UZP2
           ,concat [[8+i,i] | i <- [0,2,4,6]] -- Arm TRN1
           ,concat [[8+i,i] | i <- [1,3,5,7]] -- Arm TRN2
           ]
