...
main = do
  withArray input2 $ \arr2 -> do
    ...
    runN (\x _ -> absFloatX4# x) arr1 arr2 >>= print
    runN (\x _ -> sqrtFloatX4# x) arr1 arr2 >>= print
    ...
    runN (\_ y -> absFloatX4# y) arr1 arr2 >>= print
    runN (\_ y -> sqrtFloatX4# y) arr1 arr2 >>= print
