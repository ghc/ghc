...
-- $WK :: Bool -> T Int
-- K :: forall a. (a~Int) => Bool -> T a
--
-- cast back to T a
--  case of K co _ -> $WK b |> T (sym co)
...
-- $WK :: Bool -> T [Int]
-- K :: forall a. (a ~ Int) => Bool -> R:TList a
--
-- cast back T [Int] to T [a]  =  T out_inst_tys
--
--  case of K (co :: a ~ Int) _ -> $WK b |> T [sym co]
-}