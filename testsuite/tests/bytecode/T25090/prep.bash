...
ghc "-package-db ${db@Q} -hidir ${dep@Q} -O0 -this-unit-id dep-1.0 -fbyte-code-and-object-code -c ${dep@Q}/Dep.hs ${dep@Q}/DepApi.hs"

ghc "-package-db ${db@Q} -hidir ${obj@Q} -O0 -this-unit-id obj-1.0 -c ${obj@Q}/Obj.hs"
